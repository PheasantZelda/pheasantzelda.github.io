document.addEventListener('DOMContentLoaded', function () {
  ...
  const quizData = [
    ...
    },
    {
      ...
      options: ['2秒', '2.5秒', '3秒', '4秒'],
      answer: 1
    },
    {
      question: 'Mr.ゲーム&ウォッチの「ジャッジ」、9が出た時の効果は？',
      options: ['凍結', '埋まり', '強力なふっとばし', '回復'],
      answer: 2
    },
    {
    ...
    {
      question:
        'リトルマックの空中技で唯一300%で撃墜出来ないのはどれでしょう？',
      options: ['空上', '空前', '空下', '空後'],
      answer: 2
    },
    {
      question: 'カービィが食べると回復するアイテムは次のうちどれ？',
      options: ['ボム兵', 'ダックハントの缶', 'ダークサムスNB', 'デデデ横B'],
      answer: 2
    },
    {
      question: 'カズヤの空下の技名は？',
      options: ['雷神拳', '空斬脚', '鬼蹴り', '破砕蹴'],
      answer: 3
    },
    {
      question: 'しゃがみ歩きがあるキャラは誰？',
      options: ['ドンキー', 'リドリー', 'カービィ', 'ソラ'],
      answer: 3
    },
    {
      question: 'キンクルのメテオでない技はどれか',
      options: ['空後', '下スマッシュ', '空下', '上スマッシュ'],
      answer: 1
    },
    {
      question:
        '次のステージのうち、0%から即死するギミックがあるステージはどれ?',
      options: ['ゲーマー', 'ワイリー基地', '洞窟大作戦', 'とある星'],
      answer: 3
    },
    {
      question: '回避上がりの飛距離が一番短いファイタはどのファイタ？',
      options: ['フシギソウ', 'ゼニガメ', 'ガノンドロフ', 'リザードン'],
      answer: 1
    },
    {
      question: 'この中で一番空Nのダメージが高いファイターは？',
      options: ['ネス', 'ドンキーコング', 'ピーチ/デイジー', 'カズヤ'],
      answer: 2
    },
    {
      question: 'この中で一番全体Fが短い空前は?',
      options: ['マルス', 'スティーブ', 'プリン', 'シーク'],
      answer: 1
    },
    {
      question: 'この中で一番全体Fが短い空後は？',
      options: ['インクリング', 'ガノンドロフ', 'ベヨネッタ', 'マルス'],
      answer: 2
    },
    {
      question: '一番発生の上スマの発生が遅いファイターは？',
      options: ['パルテナ', 'Mr.ゲーム&ウォッチ', 'ガノンドロフ', 'プリン'],
      answer: 1
    },
    {
      question: '通常空中回避の発生が3Fのファイタはどのファイタか？',
      options: ['カービィ', 'リトルマック', 'プリン', 'ゲッコウガ'],
      answer: 0
    },
    {
      question: '崖放し反転NBキャンセルができるファイターはどのファイターか？',
      options: ['サムス', 'パックマン', 'リトルマック', '剣術mii'],
      answer: 1
    },
    {
    ...
    },
    {
      ...
      options: ['メタナイト', 'カービィ', 'アイク', 'ガノンドロフ'],
      answer: 1
    },
    {
      question: '身長が1番低いファイターはどれか',
      options: ['スネーク', 'プリン', 'ピカチュウ', 'カービィ'],
      answer: 3
    },
    {
      question: '1F暴れが無いキャラ',
      options: ['ゼロスーツサムス', 'ルイージ', 'プリン', 'ヨッシー'],
      answer: 0
    },
    {
      question:
        'カービィでMiiファイター(格闘、剣術、射撃)をコピーしたとき、カービィが使えないNBはどれか?',
      options: [
        'ガンナーチャージ',
        '鉄球投げ',
        'トルネードショット',
    ...
    },
    {
      ...
      options: ['ゲッコウガ', 'ガノンドロフ', 'ロイ', 'アイク'],
      answer: 0
    },
    {
      question: '壁ジャンプができないファイタはどのファイタか？',
      options: ['トゥーンリンク', 'ドクターマリオ', 'しずえ', '射撃mii'],
      answer: 2
    },
    {
      question: '横Bにスーパーアーマーがついていないのはどのファイターか？',
      options: ['カズヤ', 'カービィ', 'ドンキーコング', 'ガノンドロフ'],
      answer: 0
    },
    {
      question: '壁ジャンプができるのはどのファイターか？',
      options: ['キンクル', 'クラウド', 'カービィ', 'Mii(格闘）'],
      answer: 1
    },
    {
    ...
    },
    {
      ...
      options: ['マリオ', 'ワリオ', 'ルイージ', 'クッパ'],
      answer: 0
    },
    {
      question: '一番重いファイターは？',
      options: ['バンジョー＆カズーイ', 'シュルク', 'ケン', 'ミュウツー'],
      answer: 0,
      refLink: './parameter/parameter1.html#重さ'
    },
    {
      question: '一番軽いファイターは？',
      options: ['シーク', 'ベヨネッタ', 'ケン', 'ガオガエン'],
      answer: 0,
      refLink: './parameter/parameter1.html#重さ'
    },
    {
      question: '一番軽いファイターは？',
      options: ['カービィ', 'ネス', 'リドリー', 'ヨッシー'],
      answer: 0,
      refLink: './parameter/parameter1.html#重さ'
    },
    {
      question: 'シールドサイズの数値が一番大きいファイターは？',
      options: ['アイスクライマー', 'しずえ', 'シーク', 'フシギソウ'],
      answer: 2,
    ...
    {
      question: '最大歩行速度が一番遅いファイターは？',
      options: ['ドクターマリオ', 'クラウド', 'リドリー', '剣術Mii'],
      answer: 3,
      refLink: './parameter/parameter1.html#最大歩行速度'
    },
    {
      question: '最大歩行速度が一番速いファイターは？',
      options: ['ピクミン＆オリマー', 'ルイージ', 'フォックス', 'ゼルダ'],
      answer: 2,
      refLink: './parameter/parameter1.html#最大歩行速度'
    },
    {
      question: 'ダッシュ初速度が一番速いファイターは？',
      options: ['ドンキーコング', 'こどもリンク', 'ヒカリ', 'ガノンドルフ'],
      answer: 2,
      refLink: './parameter/parameter1.html#ダッシュ初速度'
    },
    {
      question: 'ダッシュ初速度が一番遅いファイターは？',
      options: ['クロム', 'カムイ', 'リザードン', '射撃Mii'],
      answer: 3,
      refLink: './parameter/parameter1.html#ダッシュ初速度'
    },
    {
      question: 'ダッシュ初速度が一番遅いファイターは？',
      options: ['カムイ', 'クッパ', 'パックマン', 'シーク'],
      answer: 2,
      refLink: './parameter/parameter1.html#ダッシュ初速度'
    },
    {
      question: 'ダッシュ加速量の数値が一番小さいファイターは？',
      options: ['シュルク', 'カズヤ', 'スネーク', 'リザードン'],
      answer: 0,
      refLink: './parameter/parameter1.html#ダッシュ加速量'
    },
    {
      question: 'ダッシュ加速量の数値が一番小さいファイターは？',
      options: ['ガノンドルフ', 'フォックス', 'ソラ', 'カズヤ'],
      answer: 2,
      refLink: './parameter/parameter1.html#ダッシュ加速量'
    },
    {
    ...
    },
    {
      ...
      options: ['バンジョー＆カズーイ', 'アイク', 'カムイ', 'ウルフ'],
      answer: 0,
      refLink: './parameter/parameter1.html#最大ダッシュ速度'
    },
    {
      question: '最大ダッシュ速度が一番速いファイターは？',
      options: ['カズヤ', 'ゼルダ', 'クッパ', 'インクリング'],
      answer: 2,
      refLink: './parameter/parameter1.html#最大ダッシュ速度'
    },
    {
      question: '最大ダッシュ速度が一番速いファイターは？',
      options: ['ピチュー', 'シュルク', 'マリオ', 'ソニック'],
      answer: 3,
      refLink: './parameter/parameter1.html#最大ダッシュ速度'
    },
    {
      question: '地上抵抗の数値が一番大きいファイターは？',
      options: ['むらびと', 'ガオガエン', 'テリー', 'クロム'],
      answer: 0,
      refLink: './parameter/parameter1.html#地上抵抗'
    },
    {
      question: '地上抵抗の数値が一番小さいファイターは？',
      options: ['セフィロス', 'ゲッコウガ', '射撃Mii', 'ベレトス'],
      answer: 2,
      refLink: './parameter/parameter1.html#地上抵抗'
    },
    {
      question: '地上抵抗の数値が一番小さいファイターは？',
      options: ['フシギソウ', 'ダックハント', 'ワリオ', 'ディディーコング'],
      answer: 1,
      refLink: './parameter/parameter1.html#地上抵抗'
    },
    {
      question: '空中加速の数値が一番大きいファイターは？',
      options: ['セフィロス', 'ミュウツー', 'ロゼッタ＆チコ', 'ベレトス'],
      answer: 2,
    ...
    {
      question: '空中加速の数値が一番小さいファイターは？',
      options: ['勇者', 'ゲッコウガ', 'テリー', 'ピット/ブラックピット'],
      answer: 0,
      refLink: './parameter/parameter1.html#空中加速'
    },
    {
      question: '最大空中速度が一番速いファイターは？',
      options: ['リュウ', 'メタナイト', 'こどもリンク', 'リトルマック'],
      answer: 3,
      refLink: './parameter/parameter1.html#最大空中速度'
    },
    {
      question: '最大空中速度が一番遅いファイターは？',
      options: ['アイスクライマー', 'キングクルール', 'パルテナ', '剣術Mii'],
      answer: 0,
      refLink: './parameter/parameter1.html#最大空中速度'
    },
    {
      question: '最大空中速度が一番速いファイターは？',
      options: ['フシギソウ', 'ソラ', 'リトルマック', 'リュカ'],
      answer: 2,
      refLink: './parameter/parameter1.html#最大空中速度'
    },
    {
    ...
    {
      question: '空中抵抗の数値が一番大きいファイターは？',
      options: ['ゲッコウガ', 'テリー', 'クロム', 'ジョーカー'],
      answer: 0,
      refLink: './parameter/parameter1.html#空中抵抗'
    },
    {
      question: '最大落下速度が一番速いファイターは？',
      options: ['ガノンドルフ', 'ゼロスーツサムス', 'ガオガエン', 'ロボット'],
      answer: 2,
    ...
    },
    {
      ...
      options: ['シーク', 'デデデ', 'クッパJr.', 'リトルマック'],
      answer: 2,
      refLink: './parameter/parameter1.html#最大落下速度'
    },
    {
      question: '急降下速度が一番遅いファイターは？',
      options: ['パックンフラワー', 'ウルフ', 'マリオ', 'ダックハント'],
      answer: 2,
      refLink: './parameter/parameter1.html#急降下速度'
    },
    {
      question: '急降下速度が一番速いファイターは？',
      options: ['リドリー', 'シモン/リヒター', 'セフィロス', 'ロゼッタ＆チコ'],
      answer: 1,
      refLink: './parameter/parameter1.html#急降下速度'
    },
    {
      question: '急降下速度が一番速いファイターは？',
      options: ['ピチュー', 'ミェンミェン', 'むらびと', 'ジョーカー'],
      answer: 3,
      refLink: './parameter/parameter1.html#急降下速度'
    },
    {
      question: '重力の数値が一番大きいファイターは？',
      options: ['バンジョー＆カズーイ', '格闘Mii', 'ホムラ', 'リザードン'],
      answer: 1,
      refLink: './parameter/parameter1.html#重力'
    },
    {
      question: '重力の数値が一番大きいファイターは？',
      options: ['ゲッコウガ', 'メタナイト', 'インクリング', 'ホムラ'],
      answer: 0,
      refLink: './parameter/parameter1.html#重力'
    },
    {
      question: '重力の数値が一番小さいファイターは？',
      options: ['フシギソウ', 'プリン', 'テリー', 'ピカチュウ'],
      answer: 1,
      refLink: './parameter/parameter1.html#重力'
    },
    {
      question: '大ジャンプ高さの数値が一番小さいファイターは？',
      options: ['ミュウツー', 'ロボット', 'ホムラ', 'ソラ'],
      answer: 2,
      refLink: './parameter/parameter1.html#大ジャンプ高さ'
    },
    {
      question: '大ジャンプ高さの数値が一番大きいファイターは？',
      options: ['カービィ', 'デデデ', 'ガノンドルフ', 'アイク'],
      answer: 1,
      refLink: './parameter/parameter1.html#大ジャンプ高さ'
    },
    {
      question: '大ジャンプ高さの数値が一番大きいファイターは？',
      options: ['パルテナ', 'ルカリオ', 'パックンフラワー', 'ルイージ'],
      answer: 3,
      refLink: './parameter/parameter1.html#大ジャンプ高さ'
    },
    {
      question: '小ジャンプ高さの数値が一番大きいファイターは？',
      options: ['パルテナ', 'ロイ', 'リンク', 'むらびと'],
      answer: 0,
    ...
    },
    {
      ...
      options: ['ガノンドルフ', 'Mr.ゲーム&ウォッチ', 'ソニック', 'リドリー'],
      answer: 3,
      refLink: './parameter/parameter2.html#横強全体F'
    },
    {
      question: '横強全体Fが一番長い(遅い)ファイターは？',
      options: ['ファルコ', '勇者', '格闘Mii', 'マルス'],
      answer: 1,
      refLink: './parameter/parameter2.html#横強全体F'
    },
    {
      question: '下強発生Fが一番短い(速い)ファイターは？',
      options: ['ロイ', '射撃Mii', 'ルカリオ', 'リンク'],
      answer: 0,
      refLink: './parameter/parameter2.html#下強発生F'
    },
    {
      question: '下強発生Fが一番長い(遅い)ファイターは？',
      options: ['クラウド', 'シーク', 'ロイ', 'リンク'],
      answer: 3,
      refLink: './parameter/parameter2.html#下強発生F'
    },
    {
      question: '下強発生Fが一番長い(遅い)ファイターは？',
      options: ['クッパ', '剣術Mii', 'ホムラ', 'ルキナ'],
      answer: 0,
      refLink: './parameter/parameter2.html#下強発生F'
    },
    {
      question: '下強全体Fが一番長い(遅い)ファイターは？',
      options: ['ディディーコング', 'フシギソウ', 'ドンキーコング', 'デデデ'],
      answer: 3,
      refLink: './parameter/parameter2.html#下強全体F'
    },
    {
      question: '下強全体Fが一番短い(速い)ファイターは？',
      options: ['こどもリンク', 'テリー', 'ルフレ', 'ファルコ'],
      answer: 1,
      refLink: './parameter/parameter2.html#下強全体F'
    },
    {
      question: '下強全体Fが一番長い(遅い)ファイターは？',
      options: ['ベレトス', 'リドリー', 'ダックハント', 'バンジョー＆カズーイ'],
      answer: 3,
      refLink: './parameter/parameter2.html#下強全体F'
    },
    {
      question: '上スマ発生Fが一番短い(速い)ファイターは？',
      options: ['ロゼッタ＆チコ', 'セフィロス', 'クラウド', 'むらびと'],
      answer: 0,
    ...
    {
      question: '上スマ発生Fが一番短い(速い)ファイターは？',
      options: ['マルス', 'ケン', 'リドリー', 'ウルフ'],
      answer: 1,
      refLink: './parameter/parameter2.html#上スマ発生F'
    },
    {
      question: '上スマ全体Fが一番長い(遅い)ファイターは？',
      options: ['ダックハント', 'マリオ', '剣術Mii', 'ミェンミェン'],
      answer: 2,
      refLink: './parameter/parameter2.html#上スマ全体F'
    },
    {
      question: '上スマ全体Fが一番長い(遅い)ファイターは？',
      options: ['フシギソウ', 'ディディーコング', 'マリオ', '射撃Mii'],
      answer: 0,
      refLink: './parameter/parameter2.html#上スマ全体F'
    },
    {
    ...
    },
    {
      ...
      options: ['ガオガエン', 'ヒカリ', 'ソニック', 'ロイ'],
      answer: 2,
      refLink: './parameter/parameter3.html#空前着地隙'
    },
    {
      question: '空前着地隙の数値が一番大きいファイターは？',
      options: ['カズヤ', 'ルイージ', 'リュカ', 'ジョーカー'],
      answer: 1,
      refLink: './parameter/parameter3.html#空前着地隙'
    },
    {
    ...
    },
    {
      ...
      options: ['射撃Mii', 'ソニック', 'クッパ', 'ピーチ/デイジー'],
      answer: 3,
      refLink: './parameter/parameter3.html#空後発生F'
    },
    {
      question: '空後発生Fが一番長い(遅い)ファイターは？',
      options: ['ゼルダ', 'フシギソウ', 'パックンフラワー', 'ヨッシー'],
      answer: 2,
      refLink: './parameter/parameter3.html#空後発生F'
    },
    {
      question: '空後発生Fが一番長い(遅い)ファイターは？',
      options: ['ゼニガメ', 'フシギソウ', 'マリオ', 'フォックス'],
      answer: 3,
      refLink: './parameter/parameter3.html#空後発生F'
    },
    {
    ...
    {
      question: '空後全体Fが一番短い(速い)ファイターは？',
      options: ['ファルコ', 'ルイージ', 'しずえ', 'バンジョー＆カズーイ'],
      answer: 2,
      refLink: './parameter/parameter3.html#空後全体F'
    },
    {
      question: '空後全体Fが一番長い(遅い)ファイターは？',
      options: ['ヒカリ', 'ヨッシー', 'ウルフ', 'カムイ'],
      answer: 1,
      refLink: './parameter/parameter3.html#空後全体F'
    },
    {
      question: '空後着地隙の数値が一番小さいファイターは？',
      options: ['ピクミン＆オリマー', 'ガオガエン', 'ソニック', 'ルカリオ'],
      answer: 0,
    ...
    },
    {
      ...
      options: ['マルス', 'ヒカリ', 'ソラ', 'むらびと'],
      answer: 3,
      refLink: './parameter/parameter3.html#空後着地隙'
    },
    {
      question: '空上発生Fが一番短い(速い)ファイターは？',
      options: ['ソニック', 'クラウド', 'ネス', '射撃Mii'],
      answer: 0,
      refLink: './parameter/parameter3.html#空上発生F'
    },
    {
      question: '空上発生Fが一番短い(速い)ファイターは？',
      options: ['パックンフラワー', '格闘Mii', 'ヒカリ', 'クラウド'],
      answer: 1,
      refLink: './parameter/parameter3.html#空上発生F'
    },
    {
      question: '空上発生Fが一番長い(遅い)ファイターは？',
      options: ['スティーブ', 'ケン', 'リドリー', 'スネーク'],
      answer: 2,
      refLink: './parameter/parameter3.html#空上発生F'
    },
    {
      question: '空上全体Fが一番短い(速い)ファイターは？',
      options: ['ジョーカー', '剣術Mii', 'ピーチ/デイジー', 'カービィ'],
      answer: 3,
      refLink: './parameter/parameter3.html#空上全体F'
    },
    {
      question: '空上全体Fが一番短い(速い)ファイターは？',
      options: ['パックマン', 'ロイ', 'リトルマック', 'ルイージ'],
      answer: 3,
      refLink: './parameter/parameter3.html#空上全体F'
    },
    {
    ...
    {
      question: '空上着地隙の数値が一番小さいファイターは？',
      options: ['ロックマン', 'ベレトス', 'マルス', 'しずえ'],
      answer: 2,
      refLink: './parameter/parameter3.html#空上着地隙'
    },
    {
      question: '空下発生Fが一番長い(遅い)ファイターは？',
      options: ['リザードン', 'ダックハント', 'ミェンミェン', 'ドンキーコング'],
      answer: 0,
      refLink: './parameter/parameter3.html#空下発生F'
    },
    {
      question: '空下発生Fが一番長い(遅い)ファイターは？',
      options: ['こどもリンク', 'シモン/リヒター', 'ネス', 'ロイ'],
      answer: 2,
      refLink: './parameter/parameter3.html#空下発生F'
    },
    {
      question: '空下発生Fが一番長い(遅い)ファイターは？',
      options: ['リュカ', 'マリオ', 'シーク', 'ガノンドルフ'],
      answer: 3,
      refLink: './parameter/parameter3.html#空下発生F'
    },
    {
      question: '空下全体Fが一番長い(遅い)ファイターは？',
      options: ['ソニック', 'ネス', 'リザードン', '剣術Mii'],
      answer: 3,
    ...
    {
      question: '空下全体Fが一番短い(速い)ファイターは？',
      options: ['むらびと', 'リドリー', '剣術Mii', 'ゼルダ'],
      answer: 0,
      refLink: './parameter/parameter3.html#空下全体F'
    },
    {
      question: '空下着地隙の数値が一番小さいファイターは？',
      options: ['ルキナ', 'ゼロスーツサムス', 'ガノンドルフ', 'フシギソウ'],
      answer: 3,
      refLink: './parameter/parameter3.html#空下着地隙'
    },
    {
      question: '空下着地隙の数値が一番大きいファイターは？',
      options: ['トゥーンリンク', 'ゼルダ', 'ドクターマリオ', 'ロゼッタ＆チコ'],
      answer: 0,
      refLink: './parameter/parameter3.html#空下着地隙'
    },
    {
      question: '空下着地隙の数値が一番大きいファイターは？',
      options: ['パックマン', 'ガノンドルフ', 'リドリー', 'リュウ'],
      answer: 2,
      refLink: './parameter/parameter3.html#空下着地隙'
    },
    {
      question: '次の4人のうち、下スマ全体Fが一番大きいのは？',
      options: ['ソニック', 'メタナイト', 'むらびと', 'シュルク'],
      answer: 3,
      refLink: './parameter/parameter2.html#下スマ全体F'
    },
    {
    ...
    },
    {
      ...
      options: ['リュウ', 'アイク', 'カズヤ', 'テリー'],
      answer: 3,
      refLink: './parameter/parameter1.html#歩行加速量'
    },
    {
      question: '次の4人のうち、空中加速が一番小さいのは？',
      options: ['リンク', 'インクリング', 'カムイ', '格闘Mii'],
      answer: 2,
      refLink: './parameter/parameter1.html#空中加速'
    },
    {
      question: '次の4人のうち、最大落下速度が一番小さいのは？',
      options: ['ガノンドルフ', 'シモン/リヒター', 'むらびと', 'ミェンミェン'],
      answer: 2,
      refLink: './parameter/parameter1.html#最大落下速度'
    },
    {
      question: '次の4人のうち、空下着地隙が一番大きいのは？',
      options: ['ワリオ', 'リザードン', 'キャプテン・ファルコン', 'ネス'],
      answer: 1,
      refLink: './parameter/parameter3.html#空下着地隙'
    },
    {
      question: '最大ダッシュ速度が2番目に小さいファイターは？',
      options: ['ソニック', 'ガオガエン', 'プリン', 'ガノンドルフ'],
      answer: 2,
      refLink: './parameter/parameter1.html#最大ダッシュ速度'
    },
    {
      question: '次の4人のうち、空前着地隙が一番大きいのは？',
      options: ['ドクターマリオ', '格闘Mii', 'ベヨネッタ', 'マリオ'],
      answer: 0,
      refLink: './parameter/parameter3.html#空前着地隙'
    },
    {
      question: '次の4人のうち、横スマ発生Fが一番小さいのは？',
      options: ['ロイ', 'プリン', 'リトルマック', 'サムス/ダークサムス'],
      answer: 3,
      refLink: './parameter/parameter2.html#横スマ発生F'
    },
    {
      question: '次の4人のうち、ダッシュ初速度が一番小さいのは？',
      options: ['ピチュー', 'カズヤ', 'フシギソウ', 'アイスクライマー'],
      answer: 1,
      refLink: './parameter/parameter1.html#ダッシュ初速度'
    },
    {
      question: 'シールドサイズが3番目に小さいファイターは？',
      options: ['ネス', 'キングクルール', 'ピカチュウ', 'ピチュー'],
      answer: 0,
      refLink: './parameter/parameter1.html#シールドサイズ'
    },
    {
      question: '下スマ発生Fが2番目に小さいファイターは？',
      options: ['メタナイト', 'リュウ', 'ルキナ', 'ピーチ/デイジー'],
      answer: 1,
      refLink: './parameter/parameter2.html#下スマ発生F'
    },
    {
      question: '次の4人のうち、空上着地隙が一番大きいのは？',
      options: ['ルキナ', '剣術Mii', 'リュウ', 'リトルマック'],
      answer: 3,
      refLink: './parameter/parameter3.html#空上着地隙'
    },
    {
      question: '次の4人のうち、シールドサイズが一番大きいのは？',
      options: ['リトルマック', 'ホムラ', 'サムス/ダークサムス', '剣術Mii'],
      answer: 1,
      refLink: './parameter/parameter1.html#シールドサイズ'
    },
    {
      question: '次の4人のうち、重力が一番大きいのは？',
      options: ['Wii Fit トレーナー', 'ルイージ', 'ゼルダ', 'ベレトス'],
      answer: 3,
      refLink: './parameter/parameter1.html#重力'
    },
    {
      question: '次の4人のうち、最大ダッシュ速度が一番小さいのは？',
      options: ['ベヨネッタ', 'ゼロスーツサムス', 'むらびと', 'ガノンドルフ'],
      answer: 3,
      refLink: './parameter/parameter1.html#最大ダッシュ速度'
    },
    {
      question: '次の4人のうち、横強発生Fが一番大きいのは？',
      options: ['リュカ', 'デデデ', 'ロイ', 'サムス/ダークサムス'],
      answer: 1,
      refLink: './parameter/parameter2.html#横強発生F'
    },
    {
      question: '次の4人のうち、下強発生Fが一番大きいのは？',
      options: ['ピカチュウ', 'アイク', 'ヨッシー', 'ゼルダ'],
      answer: 2,
      refLink: './parameter/parameter2.html#下強発生F'
    },
    {
      question: '次の4人のうち、空下全体Fが一番小さいのは？',
      options: ['アイスクライマー', '勇者', 'ファルコ', 'バンジョー＆カズーイ'],
      answer: 2,
      refLink: './parameter/parameter3.html#空下全体F'
    },
    {
      question: '空中ジャンプ高さが3番目に大きいファイターは？',
      options: ['ファルコ', 'ゲッコウガ', 'ヨッシー', 'カズヤ'],
      answer: 0,
      refLink: './parameter/parameter1.html#空中ジャンプ高さ'
    },
    {
      question: '次の4人のうち、横スマ全体Fが一番小さいのは？',
      options: ['パルテナ', 'ホムラ', 'アイスクライマー', 'ピカチュウ'],
      answer: 2,
      refLink: './parameter/parameter2.html#横スマ全体F'
    },
    {
      question: '次の4人のうち、その場掴み発生が一番小さいのは？',
      options: ['ベレトス', 'デデデ', 'シーク', 'リュカ'],
      answer: 0,
      refLink: './parameter/parameter1.html#その場掴み発生'
    },
    {
    ...
    },
    {
      ...
      options: ['バンジョー＆カズーイ', 'むらびと', 'ヒカリ', 'デデデ'],
      answer: 2,
      refLink: './parameter/parameter3.html#空前全体F'
    },
    {
    ...
    },
    {
      ...
      options: ['ゲッコウガ', 'フォックス', 'ゼロスーツサムス', 'ルキナ'],
      answer: 3,
      refLink: './parameter/parameter1.html#最大歩行速度'
    },
    {
    ...
    {
      question: '次の4人のうち、下スマ発生Fが一番大きいのは？',
      options: ['ネス', 'ミュウツー', 'ルフレ', 'ルキナ'],
      answer: 1,
      refLink: './parameter/parameter2.html#下スマ発生F'
    },
    {
      question: '次の4人のうち、上強全体Fが一番小さいのは？',
      options: ['ルキナ', 'ワリオ', 'ルフレ', 'ディディーコング'],
      answer: 1,
      refLink: './parameter/parameter2.html#上強全体F'
    },
    {
      question: '次の4人のうち、横スマ発生Fが一番大きいのは？',
      options: ['ロイ', 'ファルコ', 'クラウド', '格闘Mii'],
      answer: 2,
      refLink: './parameter/parameter2.html#横スマ発生F'
    },
    {
      question: '次の4人のうち、横強発生Fが一番小さいのは？',
      options: ['セフィロス', 'カービィ', 'アイク', 'シーク'],
      answer: 1,
      refLink: './parameter/parameter2.html#横強発生F'
    },
    {
      question: '空前全体Fが2番目に小さいファイターは？',
      options: ['ルイージ', 'パックマン', 'ルカリオ', 'ロイ'],
      answer: 1,
      refLink: './parameter/parameter3.html#空前全体F'
    },
    {
      question: 'その場掴み長さが2番目に小さいファイターは？',
      options: ['フォックス', 'アイスクライマー', 'リンク', '勇者'],
      answer: 3,
      refLink: './parameter/parameter1.html#その場掴み長さ'
    },
    {
      question: '次の4人のうち、上強全体Fが一番小さいのは？',
      options: ['クラウド', 'マリオ', 'ベレトス', 'ドンキーコング'],
      answer: 1,
      refLink: './parameter/parameter2.html#上強全体F'
    },
    {
      question: '次の4人のうち、空上着地隙が一番小さいのは？',
      options: ['トゥーンリンク', 'ベレトス', '格闘Mii', 'こどもリンク'],
      answer: 2,
      refLink: './parameter/parameter3.html#空上着地隙'
    },
    {
      question: '次の4人のうち、急降下速度が一番小さいのは？',
      options: ['トゥーンリンク', 'ゼニガメ', 'マルス', 'テリー'],
      answer: 1,
      refLink: './parameter/parameter1.html#急降下速度'
    },
    {
    ...
    {
      question: '次の4人のうち、横スマ全体Fが一番小さいのは？',
      options: ['ルイージ', 'ゼルダ', 'ピクミン＆オリマー', 'キングクルール'],
      answer: 0,
      refLink: './parameter/parameter2.html#横スマ全体F'
    },
    {
      question: '次の4人のうち、上スマ発生Fが一番大きいのは？',
      options: ['ピーチ/デイジー', 'クラウド', 'ピチュー', 'ロックマン'],
      answer: 0,
      refLink: './parameter/parameter2.html#上スマ発生F'
    },
    {
      question: '次の4人のうち、大ジャンプ高さが一番大きいのは？',
      options: ['リンク', 'リザードン', 'パルテナ', 'ミェンミェン'],
      answer: 2,
      refLink: './parameter/parameter1.html#大ジャンプ高さ'
    },
    {
      question: '空上全体Fが3番目に小さいファイターは？',
      options: ['スティーブ', 'ゼニガメ', 'クッパJr.', 'ピチュー'],
      answer: 3,
      refLink: './parameter/parameter3.html#空上全体F'
    },
    {
      question: '次の4人のうち、空上着地隙が一番小さいのは？',
      options: ['クラウド', 'ワリオ', 'バンジョー＆カズーイ', 'ロボット'],
      answer: 1,
      refLink: './parameter/parameter3.html#空上着地隙'
    },
    {
      question: '空下着地隙が2番目に大きいファイターは？',
      options: ['ゲッコウガ', 'カズヤ', 'クッパ', 'リドリー'],
      answer: 2,
      refLink: './parameter/parameter3.html#空下着地隙'
    },
    {
      question: '次の4人のうち、横スマ発生Fが一番大きいのは？',
      options: ['ロックマン', 'トゥーンリンク', 'ベヨネッタ', 'キングクルール'],
      answer: 3,
      refLink: './parameter/parameter2.html#横スマ発生F'
    },
    {
    ...
    },
    {
      ...
      options: ['格闘Mii', 'ヒカリ', 'ゲッコウガ', 'シーク'],
      answer: 0,
      refLink: './parameter/parameter1.html#重力'
    },
    {
      question: '空N発生Fが3番目に大きいファイターは？',
      options: ['ジョーカー', 'ホムラ', 'リトルマック', 'シュルク'],
      answer: 0,
      refLink: './parameter/parameter3.html#空N発生F'
    },
    {
      question: '上強全体Fが2番目に大きいファイターは？',
      options: ['パルテナ', 'ソラ', 'ロックマン', 'ガノンドルフ'],
      answer: 2,
      refLink: './parameter/parameter2.html#上強全体F'
    },
    {
      question: '次の4人のうち、地上抵抗が一番大きいのは？',
      options: ['Mr.ゲーム&ウォッチ', 'クッパJr.', 'リンク', 'アイク'],
      answer: 0,
      refLink: './parameter/parameter1.html#地上抵抗'
    },
    {
      question: '下スマ発生Fが3番目に小さいファイターは？',
      options: ['メタナイト', 'ルキナ', 'ケン', 'ピーチ/デイジー'],
      answer: 2,
      refLink: './parameter/parameter2.html#下スマ発生F'
    },
    {
      question: '次の4人のうち、下強全体Fが一番小さいのは？',
      options: ['ヒカリ', 'カービィ', 'ピット/ブラックピット', 'シュルク'],
      answer: 0,
      refLink: './parameter/parameter2.html#下強全体F'
    },
    {
      question: '次の4人のうち、重さが一番小さいのは？',
      options: ['ヨッシー', 'パックマン', 'ロボット', 'ヒカリ'],
      answer: 3,
      refLink: './parameter/parameter1.html#重さ'
    },
    {
      question: '次の4人のうち、その場掴み発生が一番小さいのは？',
      options: ['ベヨネッタ', 'カズヤ', '格闘Mii', 'マルス'],
      answer: 2,
      refLink: './parameter/parameter1.html#その場掴み発生'
    },
    {
      question: '次の4人のうち、空下全体Fが一番大きいのは？',
      options: ['メタナイト', 'パックンフラワー', 'セフィロス', 'ジョーカー'],
      answer: 2,
      refLink: './parameter/parameter3.html#空下全体F'
    },
    {
      question: '大ジャンプ高さが2番目に小さいファイターは？',
      options: ['スネーク', 'プリン', 'スティーブ', 'カズヤ'],
      answer: 3,
      refLink: './parameter/parameter1.html#大ジャンプ高さ'
    },
    {
      question: '次の4人のうち、最大ダッシュ速度が一番小さいのは？',
      options: ['セフィロス', 'ネス', 'シモン/リヒター', 'シュルク'],
      answer: 2,
      refLink: './parameter/parameter1.html#最大ダッシュ速度'
    },
    {
      question: '次の4人のうち、その場掴み長さが一番大きいのは？',
      options: ['カズヤ', 'ファルコ', 'ソラ', 'アイスクライマー'],
      answer: 0,
      refLink: './parameter/parameter1.html#その場掴み長さ'
    },
    {
      question: '次の4人のうち、その場掴み長さが一番小さいのは？',
      options: ['リュカ', 'リドリー', 'インクリング', 'ピチュー'],
      answer: 2,
      refLink: './parameter/parameter1.html#その場掴み長さ'
    },
    {
      question: '次の4人のうち、重さが一番小さいのは？',
      options: ['射撃Mii', 'シモン/リヒター', 'キングクルール', 'ピカチュウ'],
      answer: 3,
      refLink: './parameter/parameter1.html#重さ'
    },
    {
      question: '次の4人のうち、空N全体Fが一番大きいのは？',
      options: ['セフィロス', 'ケン', '格闘Mii', 'シモン/リヒター'],
      answer: 2,
      refLink: './parameter/parameter3.html#空N全体F'
    },
    {
      question: '次の4人のうち、最大ダッシュ速度が一番小さいのは？',
      options: ['ケン', '射撃Mii', 'ウルフ', 'カムイ'],
      answer: 1,
      refLink: './parameter/parameter1.html#最大ダッシュ速度'
    },
    {
      question: '次の4人のうち、空後発生Fが一番小さいのは？',
      options: ['ドンキーコング', 'ジョーカー', 'ルキナ', 'ディディーコング'],
      answer: 3,
      refLink: './parameter/parameter3.html#空後発生F'
    },
    {
      question: '次の4人のうち、空後着地隙が一番大きいのは？',
      options: ['ルフレ', 'ガオガエン', 'バンジョー＆カズーイ', 'ゼルダ'],
      answer: 2,
      refLink: './parameter/parameter3.html#空後着地隙'
    },
    {
      question: '次の4人のうち、下強発生Fが一番小さいのは？',
      options: ['リュカ', 'ルカリオ', 'リドリー', 'トゥーンリンク'],
      answer: 0,
      refLink: './parameter/parameter2.html#下強発生F'
    },
    {
      question: '次の4人のうち、地上抵抗が一番小さいのは？',
      options: ['カムイ', 'ガノンドルフ', 'パックマン', 'ゼニガメ'],
      answer: 3,
      refLink: './parameter/parameter1.html#地上抵抗'
    },
    {
      question: '次の4人のうち、空中加速が一番小さいのは？',
      options: ['クロム', 'カズヤ', 'バンジョー＆カズーイ', 'ウルフ'],
      answer: 1,
      refLink: './parameter/parameter1.html#空中加速'
    },
    {
      question: '空後着地隙が3番目に大きいファイターは？',
      options: ['ロックマン', 'スネーク', 'ミェンミェン', 'ピチュー'],
      answer: 0,
      refLink: './parameter/parameter3.html#空後着地隙'
    },
    {
      question: '次の4人のうち、最大落下速度が一番大きいのは？',
      options: ['ガオガエン', 'ルカリオ', 'ソラ', 'フォックス'],
      answer: 3,
      refLink: './parameter/parameter1.html#最大落下速度'
    },
    {
      question: '最大ダッシュ速度が3番目に小さいファイターは？',
      options: ['ガノンドルフ', '射撃Mii', 'ルフレ', 'ソニック'],
      answer: 2,
      refLink: './parameter/parameter1.html#最大ダッシュ速度'
    },
    {
      question: '次の4人のうち、最大歩行速度が一番大きいのは？',
      options: ['パックンフラワー', 'メタナイト', 'リトルマック', 'ピカチュウ'],
      answer: 2,
      refLink: './parameter/parameter1.html#最大歩行速度'
    },
    {
      question: '次の4人のうち、回避上がり距離が一番大きいのは？',
      options: ['マリオ', 'カービィ', 'バンジョー＆カズーイ', 'ガノンドルフ'],
      answer: 3,
      refLink: './parameter/parameter1.html#回避上がり距離'
    },
    {
    ...
    },
    {
      ...
      options: ['スネーク', 'ベヨネッタ', 'マリオ', 'サムス/ダークサムス'],
      answer: 0,
      refLink: './parameter/parameter3.html#空前全体F'
    },
    {
      question: '次の4人のうち、上スマ発生Fが一番大きいのは？',
      options: ['ルキナ', 'メタナイト', '勇者', 'Mr.ゲーム&ウォッチ'],
      answer: 3,
      refLink: './parameter/parameter2.html#上スマ発生F'
    },
    {
    ...
    },
    {
      ...
      options: ['シュルク', 'ベレトス', 'ロックマン', 'クッパ'],
      answer: 2,
      refLink: './parameter/parameter2.html#下スマ全体F'
    },
    {
      question: '次の4人のうち、空後発生Fが一番大きいのは？',
      options: ['カービィ', 'しずえ', 'ゼニガメ', 'フォックス'],
      answer: 1,
      refLink: './parameter/parameter3.html#空後発生F'
    },
    {
      question: '次の4人のうち、空上発生Fが一番小さいのは？',
      options: ['ゲッコウガ', 'ネス', 'ミュウツー', 'デデデ'],
      answer: 0,
      refLink: './parameter/parameter3.html#空上発生F'
    },
    {
      question: '次の4人のうち、ダッシュ初速度が一番大きいのは？',
      options: ['ピーチ/デイジー', 'プリン', 'ソラ', 'メタナイト'],
      answer: 3,
      refLink: './parameter/parameter1.html#ダッシュ初速度'
    },
    {
      question: '次の4人のうち、空上発生Fが一番大きいのは？',
      options: ['ジョーカー', 'アイスクライマー', 'クラウド', 'ミュウツー'],
      answer: 3,
      refLink: './parameter/parameter3.html#空上発生F'
    },
    {
      question: '歩行加速量が3番目に大きいファイターは？',
      options: ['サムス/ダークサムス', 'リュウ', 'スティーブ', 'ミュウツー'],
      answer: 2,
      refLink: './parameter/parameter1.html#歩行加速量'
    },
    {
      question: '空後全体Fが3番目に大きいファイターは？',
      options: ['キングクルール', 'ヨッシー', 'ピチュー', 'アイク'],
      answer: 1,
      refLink: './parameter/parameter3.html#空後全体F'
    },
    {
      question: '次の4人のうち、重力が一番小さいのは？',
      options: ['フォックス', 'ルカリオ', 'プリン', 'むらびと'],
      answer: 2,
      refLink: './parameter/parameter1.html#重力'
    },
    {
      question: '空前着地隙が2番目に小さいファイターは？',
      options: ['こどもリンク', 'シーク', 'ミェンミェン', 'ゼニガメ'],
      answer: 1,
      refLink: './parameter/parameter3.html#空前着地隙'
    },
    {
      question: '次の4人のうち、上強発生Fが一番小さいのは？',
      options: ['カムイ', 'アイク', 'キングクルール', 'カービィ'],
      answer: 3,
      refLink: './parameter/parameter2.html#上強発生F'
    },
    {
      question: '次の4人のうち、上強全体Fが一番大きいのは？',
      options: ['剣術Mii', 'クッパ', 'ホムラ', 'ピチュー'],
      answer: 1,
      refLink: './parameter/parameter2.html#上強全体F'
    },
    {
      question: '空前発生Fが3番目に小さいファイターは？',
      options: ['マルス', 'ルキナ', 'ロボット', 'パックマン'],
      answer: 3,
      refLink: './parameter/parameter3.html#空前発生F'
    },
    {
      question: '上強全体Fが3番目に小さいファイターは？',
      options: ['カービィ', 'ケン', 'ゼニガメ', 'スティーブ'],
      answer: 3,
      refLink: './parameter/parameter2.html#上強全体F'
    },
    {
      question: '次の4人のうち、空上全体Fが一番大きいのは？',
      options: ['シーク', 'カムイ', 'ミュウツー', 'クッパJr.'],
      answer: 0,
      refLink: './parameter/parameter3.html#空上全体F'
    },
    {
    ...
    },
    {
      ...
      options: ['スティーブ', 'リュカ', 'キングクルール', 'リンク'],
      answer: 3,
      refLink: './parameter/parameter2.html#上スマ全体F'
    },
    {
      question: '次の4人のうち、DA 全体Fが一番大きいのは？',
      options: ['ドンキーコング', 'カズヤ', 'ドクターマリオ', '勇者'],
      answer: 3,
      refLink: './parameter/parameter2.html#DA 全体F'
    },
    {
      question: '次の4人のうち、空中抵抗が一番小さいのは？',
      options: ['ピーチ/デイジー', 'ヒカリ', 'ミェンミェン', 'ネス'],
      answer: 0,
      refLink: './parameter/parameter1.html#空中抵抗'
    },
    {
      question: '次の4人のうち、最大落下速度が一番大きいのは？',
      options: ['プリン', 'ロイ', 'ファルコ', 'カムイ'],
      answer: 2,
      refLink: './parameter/parameter1.html#最大落下速度'
    },
    {
    ...
    },
    {
      ...
      options: ['シュルク', 'ゼルダ', 'リドリー', 'アイク'],
      answer: 3,
      refLink: './parameter/parameter1.html#回避上がり距離'
    },
    {
      question: '次の4人のうち、空後着地隙が一番小さいのは？',
      options: ['ソニック', 'むらびと', 'ネス', 'シュルク'],
      answer: 2,
      refLink: './parameter/parameter3.html#空後着地隙'
    },
    {
      question: '次の4人のうち、ダッシュ加速量が一番小さいのは？',
      options: ['リュカ', 'ディディーコング', 'アイク', 'ファルコ'],
      answer: 2,
      refLink: './parameter/parameter1.html#ダッシュ加速量'
    },
    {
      question: '下強全体Fが2番目に大きいファイターは？',
      options: ['サムス/ダークサムス', 'ロックマン', 'クッパ', 'スティーブ'],
      answer: 1,
      refLink: './parameter/parameter2.html#下強全体F'
    },
    {
      question: '次の4人のうち、小ジャンプ高さが一番大きいのは？',
      options: ['カズヤ', 'パックンフラワー', 'カービィ', 'カムイ'],
      answer: 1,
      refLink: './parameter/parameter1.html#小ジャンプ高さ'
    },
    {
      question: '上スマ発生Fが2番目に大きいファイターは？',
      options: ['セフィロス', 'アイク', 'リュカ', 'フシギソウ'],
      answer: 3,
      refLink: './parameter/parameter2.html#上スマ発生F'
    },
    {
    ...
    },
    {
      ...
      options: ['インクリング', 'スティーブ', '射撃Mii', 'Mr.ゲーム&ウォッチ'],
      answer: 3,
      refLink: './parameter/parameter2.html#上強発生F'
    },
    {
      question: '次の4人のうち、ダッシュ初速度が一番大きいのは？',
      options: ['射撃Mii', 'マリオ', 'セフィロス', 'ゼニガメ'],
      answer: 1,
      refLink: './parameter/parameter1.html#ダッシュ初速度'
    },
    {
    ...
    },
    {
      ...
      options: ['ケン', 'リュカ', 'リュウ', 'フシギソウ'],
      answer: 1,
      refLink: './parameter/parameter2.html#下強発生F'
    },
    {
      question: '次の4人のうち、重さが一番小さいのは？',
      options: ['ピチュー', 'アイスクライマー', 'ロイ', 'キングクルール'],
      answer: 0,
      refLink: './parameter/parameter1.html#重さ'
    },
    {
      question: '次の4人のうち、空上発生Fが一番大きいのは？',
      options: ['ピーチ/デイジー', 'ガオガエン', 'ベヨネッタ', '射撃Mii'],
      answer: 3,
      refLink: './parameter/parameter3.html#空上発生F'
    },
    {
      question: '次の4人のうち、空上全体Fが一番大きいのは？',
      options: ['ガノンドルフ', 'カムイ', 'こどもリンク', 'クロム'],
      answer: 2,
      refLink: './parameter/parameter3.html#空上全体F'
    },
    {
      question: '次の4人のうち、DA 発生Fが一番大きいのは？',
      options: ['リドリー', 'ウルフ', '射撃Mii', 'カービィ'],
      answer: 0,
      refLink: './parameter/parameter2.html#DA 発生F'
    },
    {
      question: '空下着地隙が3番目に小さいファイターは？',
      options: ['ヒカリ', 'しずえ', 'ピーチ/デイジー', 'インクリング'],
      answer: 1,
      refLink: './parameter/parameter3.html#空下着地隙'
    },
    {
      question: '空下発生Fが3番目に大きいファイターは？',
      options: ['射撃Mii', 'スネーク', 'ベレトス', 'スティーブ'],
      answer: 2,
      refLink: './parameter/parameter3.html#空下発生F'
    },
    {
    ...
    },
    {
      ...
      options: ['マリオ', 'ミェンミェン', 'ヨッシー', 'サムス/ダークサムス'],
      answer: 3,
      refLink: './parameter/parameter1.html#その場掴み発生'
    },
    {
      question: '次の4人のうち、空下発生Fが一番小さいのは？',
      options: ['格闘Mii', 'クラウド', 'ソニック', 'ピチュー'],
      answer: 1,
      refLink: './parameter/parameter3.html#空下発生F'
    },
    {
      question: '次の4人のうち、最大空中速度が一番大きいのは？',
      options: ['パックンフラワー', 'ルキナ', 'ソラ', 'バンジョー＆カズーイ'],
      answer: 1,
      refLink: './parameter/parameter1.html#最大空中速度'
    },
    {
      question: '次の4人のうち、空前全体Fが一番小さいのは？',
      options: ['ゼロスーツサムス', 'リドリー', 'ヒカリ', 'ピカチュウ'],
      answer: 2,
      refLink: './parameter/parameter3.html#空前全体F'
    },
    {
      question: '次の4人のうち、空前発生Fが一番小さいのは？',
      options: ['格闘Mii', 'リドリー', 'ファルコ', 'インクリング'],
      answer: 2,
      refLink: './parameter/parameter3.html#空前発生F'
    },
    {
    ...
    {
      question: '次の4人のうち、ダッシュ初速度が一番大きいのは？',
      options: ['トゥーンリンク', 'セフィロス', 'リュカ', 'ダックハント'],
      answer: 1,
      refLink: './parameter/parameter1.html#ダッシュ初速度'
    },
    {
      question: '次の4人のうち、最大歩行速度が一番大きいのは？',
      options: ['ソラ', 'カービィ', 'リトルマック', 'Wii Fit トレーナー'],
      answer: 2,
      refLink: './parameter/parameter1.html#最大歩行速度'
    },
    {
      question: '次の4人のうち、重さが一番小さいのは？',
      options: ['ピチュー', 'リュカ', 'マリオ', 'ゲッコウガ'],
      answer: 0,
      refLink: './parameter/parameter1.html#重さ'
    },
    {
      question: '空N全体Fが3番目に小さいファイターは？',
      options: ['ケン', 'インクリング', 'スティーブ', 'カズヤ'],
      answer: 0,
      refLink: './parameter/parameter3.html#空N全体F'
    },
    {
      question: '次の4人のうち、横スマ全体Fが一番大きいのは？',
      options: ['シモン/リヒター', 'リンク', 'ルイージ', 'ソラ'],
      answer: 0,
      refLink: './parameter/parameter2.html#横スマ全体F'
    },
    {
      question: '下強全体Fが2番目に小さいファイターは？',
      options: ['ケン', 'ネス', 'ルイージ', 'リュウ'],
      answer: 2,
      refLink: './parameter/parameter2.html#下強全体F'
    },
    {
      question: '次の4人のうち、空後全体Fが一番小さいのは？',
      options: ['リドリー', 'ガオガエン', 'ドクターマリオ', 'シュルク'],
      answer: 2,
      refLink: './parameter/parameter3.html#空後全体F'
    },
    {
      question: '次の4人のうち、下スマ全体Fが一番小さいのは？',
      options: ['カービィ', 'ネス', '勇者', 'スネーク'],
      answer: 3,
      refLink: './parameter/parameter2.html#下スマ全体F'
    },
    {
      question: '次の4人のうち、空後発生Fが一番大きいのは？',
      options: ['アイク', 'ルキナ', 'クラウド', 'クロム'],
      answer: 2,
      refLink: './parameter/parameter3.html#空後発生F'
    },
    {
    ...
    },
    {
      ...
      options: ['格闘Mii', 'リトルマック', 'フォックス', 'ピチュー'],
      answer: 1,
      refLink: './parameter/parameter1.html#最大落下速度'
    },
    {
      question: '空中ジャンプ高さが2番目に小さいファイターは？',
      options: ['スティーブ', 'バンジョー＆カズーイ', 'メタナイト', 'カービィ'],
      answer: 2,
      refLink: './parameter/parameter1.html#空中ジャンプ高さ'
    },
    {
      question: '次の4人のうち、横強発生Fが一番大きいのは？',
      options: ['スティーブ', 'ネス', 'ピーチ/デイジー', '勇者'],
      answer: 3,
      refLink: './parameter/parameter2.html#横強発生F'
    },
    {
      question: '横強全体Fが2番目に大きいファイターは？',
      options: ['ソラ', 'パルテナ', 'ミェンミェン', 'ロックマン'],
      answer: 3,
      refLink: './parameter/parameter2.html#横強全体F'
    },
    {
      question: '次の4人のうち、空前着地隙が一番大きいのは？',
      options: ['ガノンドルフ', 'ヒカリ', 'シーク', 'クラウド'],
      answer: 0,
      refLink: './parameter/parameter3.html#空前着地隙'
    },
    {
      question: '次の4人のうち、空N着地隙が一番小さいのは？',
      options: ['格闘Mii', 'テリー', 'サムス/ダークサムス', 'シモン/リヒター'],
      answer: 0,
      refLink: './parameter/parameter3.html#空N着地隙'
    },
    {
      question: '次の4人のうち、上スマ全体Fが一番大きいのは？',
      options: ['ガオガエン', 'ロイ', 'トゥーンリンク', 'ルカリオ'],
      answer: 3,
      refLink: './parameter/parameter2.html#上スマ全体F'
    },
    {
      question: '小ジャンプ高さが2番目に小さいファイターは？',
      options: ['プリン', 'ゲッコウガ', 'スティーブ', 'ロックマン'],
      answer: 2,
      refLink: './parameter/parameter1.html#小ジャンプ高さ'
    },
    {
      question: '次の4人のうち、横強全体Fが一番大きいのは？',
      options: ['クッパ', 'ロボット', 'むらびと', 'ルカリオ'],
      answer: 0,
      refLink: './parameter/parameter2.html#横強全体F'
    },
    {
    ...
    },
    {
      ...
      options: ['ガノンドルフ', 'プリン', 'シモン/リヒター', 'リトルマック'],
      answer: 2,
      refLink: './parameter/parameter1.html#空中加速'
    },
    {
      question: '空上着地隙が2番目に小さいファイターは？',
      options: ['ワリオ', 'ルイージ', 'インクリング', 'ゼロスーツサムス'],
      answer: 2,
      refLink: './parameter/parameter3.html#空上着地隙'
    },
    {
    ...
    },
    {
      ...
      options: ['マリオ', 'サムス/ダークサムス', 'シュルク', 'ピカチュウ'],
      answer: 1,
      refLink: './parameter/parameter1.html#歩行加速量'
    },
    {
      question: '次の4人のうち、空後全体Fが一番大きいのは？',
      options: ['ベヨネッタ', 'パックンフラワー', 'シュルク', 'ルカリオ'],
      answer: 1,
      refLink: './parameter/parameter3.html#空後全体F'
    },
    {
      question: '次の4人のうち、空下着地隙が一番小さいのは？',
      options: ['フシギソウ', 'ゼロスーツサムス', 'ロゼッタ＆チコ', 'ゼルダ'],
      answer: 2,
      refLink: './parameter/parameter3.html#空下着地隙'
    },
    {
      question: '次の4人のうち、空中抵抗が一番小さいのは？',
      options: ['クッパJr.', 'キングクルール', 'トゥーンリンク', 'むらびと'],
      answer: 2,
      refLink: './parameter/parameter1.html#空中抵抗'
    },
    {
      question: '次の4人のうち、空中抵抗が一番大きいのは？',
      options: ['フォックス', 'スネーク', 'インクリング', 'セフィロス'],
      answer: 0,
      refLink: './parameter/parameter1.html#空中抵抗'
    },
    {
      question: '次の4人のうち、空N全体Fが一番大きいのは？',
      options: ['ホムラ', 'リンク', 'マリオ', 'ヨッシー'],
      answer: 0,
      refLink: './parameter/parameter3.html#空N全体F'
    },
    {
      question: '次の4人のうち、空下発生Fが一番大きいのは？',
      options: ['カズヤ', '格闘Mii', 'テリー', 'シモン/リヒター'],
      answer: 0,
      refLink: './parameter/parameter3.html#空下発生F'
    },
    {
    ...
    {
      question: '次の4人のうち、空下全体Fが一番小さいのは？',
      options: ['スネーク', 'シーク', 'ロボット', 'ウルフ'],
      answer: 3,
      refLink: './parameter/parameter3.html#空下全体F'
    },
    {
      question: '次の4人のうち、空N全体Fが一番大きいのは？',
      options: ['ガオガエン', 'ピカチュウ', 'ガノンドルフ', 'ピーチ/デイジー'],
      answer: 3,
      refLink: './parameter/parameter3.html#空N全体F'
    },
    {
      question: '次の4人のうち、下強全体Fが一番小さいのは？',
      options: ['ルイージ', 'デデデ', 'ドンキーコング', 'ベレトス'],
      answer: 0,
      refLink: './parameter/parameter2.html#下強全体F'
    },
    {
    ...
    },
    {
      ...
      options: ['スティーブ', 'クッパ', 'ダックハント', 'ロゼッタ＆チコ'],
      answer: 2,
      refLink: './parameter/parameter1.html#シールドサイズ'
    },
    {
    ...
    {
      question: '次の4人のうち、空N着地隙が一番小さいのは？',
      options: ['マリオ', 'パックマン', 'ピット/ブラックピット', 'ピチュー'],
      answer: 0,
      refLink: './parameter/parameter3.html#空N着地隙'
    },
    {
    ...
    },
    {
      ...
      options: ['クラウド', 'ゲッコウガ', 'ケン', 'ロックマン'],
      answer: 2,
      refLink: './parameter/parameter1.html#空中ジャンプ高さ'
    },
    {
      question: '下強全体Fが3番目に小さいファイターは？',
      options: ['ネス', 'リュウ', 'ルイージ', 'リュカ'],
      answer: 1,
      refLink: './parameter/parameter2.html#下強全体F'
    },
    {
      question: '次の4人のうち、重力が一番小さいのは？',
      options: ['フォックス', 'Wii Fit トレーナー', 'リドリー', 'ソラ'],
      answer: 3,
      refLink: './parameter/parameter1.html#重力'
    },
    {
    ...
    },
    {
      ...
      options: ['ゼロスーツサムス', 'ヒカリ', 'リトルマック', 'ソニック'],
      answer: 0,
      refLink: './parameter/parameter1.html#ダッシュ初速度'
    },
    {
      question: '次の4人のうち、空N着地隙が一番小さいのは？',
      options: ['こどもリンク', 'フォックス', 'リドリー', 'ゼロスーツサムス'],
      answer: 0,
      refLink: './parameter/parameter3.html#空N着地隙'
    },
    {
      question: '空後全体Fが2番目に小さいファイターは？',
      options: ['ディディーコング', 'ジョーカー', 'リンク', 'こどもリンク'],
      answer: 0,
      refLink: './parameter/parameter3.html#空後全体F'
    },
    {
      question: 'シールドサイズが3番目に大きいファイターは？',
      options: ['クッパ', 'デデデ', 'リザードン', 'ドンキーコング'],
      answer: 0,
      refLink: './parameter/parameter1.html#シールドサイズ'
    },
    {
      question: '次の4人のうち、DA 全体Fが一番小さいのは？',
      options: ['クラウド', 'パックンフラワー', 'シモン/リヒター', 'ピチュー'],
      answer: 3,
      refLink: './parameter/parameter2.html#DA 全体F'
    },
    {
      question: '空下着地隙が3番目に大きいファイターは？',
      options: ['リドリー', 'クッパ', 'ゲッコウガ', 'ベヨネッタ'],
      answer: 0,
      refLink: './parameter/parameter3.html#空下着地隙'
    },
    {
      question: '重力が3番目に小さいファイターは？',
      options: ['カービィ', 'フォックス', 'スティーブ', 'ゲッコウガ'],
      answer: 0,
      refLink: './parameter/parameter1.html#重力'
    },
    {
      question: '次の4人のうち、空前発生Fが一番大きいのは？',
      options: ['シーク', 'ドクターマリオ', '勇者', 'リドリー'],
      answer: 1,
      refLink: './parameter/parameter3.html#空前発生F'
    },
    {
      question: '次の4人のうち、空下全体Fが一番大きいのは？',
      options: ['カムイ', 'リザードン', 'ケン', 'ベヨネッタ'],
      answer: 3,
      refLink: './parameter/parameter3.html#空下全体F'
    },
    {
      question: '次の4人のうち、空中ジャンプ高さが一番小さいのは？',
      options: ['パルテナ', 'ヨッシー', 'ミュウツー', 'カズヤ'],
      answer: 0,
      refLink: './parameter/parameter1.html#空中ジャンプ高さ'
    },
    {
      question: '次の4人のうち、上スマ全体Fが一番小さいのは？',
      options: ['ゼルダ', 'ファルコ', 'ヒカリ', '剣術Mii'],
      answer: 1,
      refLink: './parameter/parameter2.html#上スマ全体F'
    },
    {
      question: '空N着地隙が3番目に大きいファイターは？',
      options: ['クッパ', 'フシギソウ', 'ロックマン', 'パックンフラワー'],
      answer: 1,
      refLink: './parameter/parameter3.html#空N着地隙'
    },
    {
      question: '次の4人のうち、最大歩行速度が一番小さいのは？',
      options: ['ヨッシー', 'ピチュー', 'トゥーンリンク', 'ベレトス'],
      answer: 3,
      refLink: './parameter/parameter1.html#最大歩行速度'
    },
    {
    ...
    },
    {
      ...
      options: ['ネス', 'リュカ', 'ピチュー', 'ヨッシー'],
      answer: 2,
      refLink: './parameter/parameter1.html#シールドサイズ'
    },
    {
      question: '下スマ発生Fが3番目に大きいファイターは？',
      options: ['メタナイト', 'キングクルール', 'ミュウツー', 'リュカ'],
      answer: 2,
      refLink: './parameter/parameter2.html#下スマ発生F'
    },
    {
      question: '上スマ発生Fが2番目に小さいファイターは？',
      options: ['ファルコ', 'クッパJr.', 'キングクルール', 'ディディーコング'],
      answer: 2,
      refLink: './parameter/parameter2.html#上スマ発生F'
    },
    {
      question: '次の4人のうち、空N発生Fが一番小さいのは？',
      options: ['クッパJr.', 'ケン', 'こどもリンク', 'パルテナ'],
      answer: 2,
      refLink: './parameter/parameter3.html#空N発生F'
    },
    {
      question: '次の4人のうち、最大落下速度が一番大きいのは？',
      options: ['剣術Mii', 'ワリオ', 'ベヨネッタ', 'リドリー'],
      answer: 3,
      refLink: './parameter/parameter1.html#最大落下速度'
    },
    {
      question: '崖掴まり姿勢が2番目に大きいファイターは？',
      options: ['クッパJr.', 'ソニック', 'ピチュー', 'フシギソウ'],
      answer: 2,
      refLink: './parameter/parameter1.html#崖掴まり姿勢'
    },
    {
      question: '次の4人のうち、歩行加速量が一番小さいのは？',
      options: ['メタナイト', 'Mr.ゲーム&ウォッチ', 'パルテナ', 'リンク'],
      answer: 1,
      refLink: './parameter/parameter1.html#歩行加速量'
    },
    {
    ...
    },
    {
      ...
      options: ['アイスクライマー', 'シーク', 'こどもリンク', 'ミェンミェン'],
      answer: 2,
      refLink: './parameter/parameter3.html#空後着地隙'
    },
    {
      question: 'DA 全体Fが3番目に大きいファイターは？',
      options: ['ロックマン', 'クッパ', 'トゥーンリンク', 'リンク'],
      answer: 0,
      refLink: './parameter/parameter2.html#DA 全体F'
    },
    {
    ...
    },
    {
      ...
      options: ['リュカ', 'シーク', 'ミェンミェン', 'こどもリンク'],
      answer: 3,
      refLink: './parameter/parameter3.html#空前着地隙'
    },
    {
      question: '次の4人のうち、上強発生Fが一番大きいのは？',
      options: ['デデデ', 'スティーブ', 'ゲッコウガ', 'リュカ'],
      answer: 2,
      refLink: './parameter/parameter2.html#上強発生F'
    },
    {
      question: 'シールドサイズが2番目に大きいファイターは？',
      options: ['ドンキーコング', 'キングクルール', 'デデデ', 'クッパ'],
      answer: 0,
      refLink: './parameter/parameter1.html#シールドサイズ'
    },
    {
    ...
    {
      question: '次の4人のうち、空下発生Fが一番大きいのは？',
      options: ['ゼルダ', 'トゥーンリンク', 'むらびと', 'ベヨネッタ'],
      answer: 3,
      refLink: './parameter/parameter3.html#空下発生F'
    },
    {
      question: '空N着地隙が2番目に大きいファイターは？',
      options: ['ロックマン', 'クッパ', 'バンジョー＆カズーイ', 'スティーブ'],
      answer: 2,
      refLink: './parameter/parameter3.html#空N着地隙'
    },
    {
      question: '空上発生Fが3番目に大きいファイターは？',
      options: ['シモン/リヒター', 'マリオ', 'シーク', 'セフィロス'],
      answer: 0,
      refLink: './parameter/parameter3.html#空上発生F'
    },
    {
      question: '次の4人のうち、下強全体Fが一番大きいのは？',
      options: ['ファルコ', 'バンジョー＆カズーイ', 'ケン', 'リザードン'],
      answer: 1,
      refLink: './parameter/parameter2.html#下強全体F'
    },
    {
      question: '空N発生Fが2番目に大きいファイターは？',
      options: ['ロボット', 'ジョーカー', 'ゲッコウガ', 'シュルク'],
      answer: 3,
      refLink: './parameter/parameter3.html#空N発生F'
    },
    {
    ...
    },
    {
      ...
      options: ['シーク', 'ルイージ', 'ワリオ', 'プリン'],
      answer: 1,
      refLink: './parameter/parameter2.html#DA 発生F'
    },
    {
      question: '次の4人のうち、急降下速度が一番大きいのは？',
      options: ['ロイ', 'ネス', 'シモン/リヒター', 'ワリオ'],
      answer: 2,
      refLink: './parameter/parameter1.html#急降下速度'
    },
    {
      question: '次の4人のうち、空上全体Fが一番大きいのは？',
      options: ['ワリオ', 'むらびと', 'テリー', 'アイク'],
      answer: 3,
      refLink: './parameter/parameter3.html#空上全体F'
    },
    {
      question: '次の4人のうち、横強全体Fが一番小さいのは？',
      options: ['ロイ', 'ドンキーコング', 'リュウ', 'ケン'],
      answer: 2,
      refLink: './parameter/parameter2.html#横強全体F'
    },
    {
      question: '次の4人のうち、重力が一番小さいのは？',
      options: ['ジョーカー', 'シーク', 'フシギソウ', 'ソラ'],
      answer: 3,
      refLink: './parameter/parameter1.html#重力'
    },
    {
    ...
    {
      question: '次の4人のうち、その場掴み長さが一番小さいのは？',
      options: ['ロックマン', 'クッパJr.', 'ミュウツー', 'フォックス'],
      answer: 3,
      refLink: './parameter/parameter1.html#その場掴み長さ'
    },
    {
      question: '次の4人のうち、空上着地隙が一番小さいのは？',
      options: ['テリー', 'ウルフ', 'フシギソウ', 'ロイ'],
      answer: 0,
      refLink: './parameter/parameter3.html#空上着地隙'
    },
    {
      question: '次の4人のうち、最大歩行速度が一番大きいのは？',
      options: ['ドクターマリオ', 'むらびと', 'ネス', 'ゲッコウガ'],
      answer: 3,
      refLink: './parameter/parameter1.html#最大歩行速度'
    },
    {
    ...
    {
      question: '次の4人のうち、その場掴み発生が一番小さいのは？',
      options: ['カズヤ', 'シーク', 'ゲッコウガ', 'ヨッシー'],
      answer: 1,
      refLink: './parameter/parameter1.html#その場掴み発生'
    },
    {
      question: '回避上がり距離が3番目に小さいファイターは？',
      options: ['こどもリンク', 'しずえ', 'アイスクライマー', 'むらびと'],
      answer: 2,
      refLink: './parameter/parameter1.html#回避上がり距離'
    },
    {
      question: '次の4人のうち、最大歩行速度が一番小さいのは？',
      options: ['ルイージ', 'ロボット', 'むらびと', 'プリン'],
      answer: 3,
      refLink: './parameter/parameter1.html#最大歩行速度'
    },
    {
      question: '次の4人のうち、上スマ全体Fが一番小さいのは？',
      options: ['マルス', 'ディディーコング', 'カズヤ', 'シーク'],
      answer: 2,
      refLink: './parameter/parameter2.html#上スマ全体F'
    },
    {
      question: '重さが3番目に大きいファイターは？',
      options: ['キングクルール', 'クッパ', 'ドンキーコング', 'ガノンドルフ'],
      answer: 2,
      refLink: './parameter/parameter1.html#重さ'
    },
    {
      question: '次の4人のうち、下スマ発生Fが一番大きいのは？',
      options: ['ガオガエン', 'ソラ', 'ケン', 'ソニック'],
      answer: 1,
      refLink: './parameter/parameter2.html#下スマ発生F'
    },
    {
      question: 'ダッシュ加速量が2番目に小さいファイターは？',
      options: ['カムイ', 'ルカリオ', 'ディディーコング', 'ルフレ'],
      answer: 0,
      refLink: './parameter/parameter1.html#ダッシュ加速量'
    },
    {
      question: '下強発生Fが3番目に大きいファイターは？',
      options: ['バンジョー＆カズーイ', 'ベレトス', 'スティーブ', 'リュウ'],
      answer: 1,
      refLink: './parameter/parameter2.html#下強発生F'
    },
    {
      question: '空下着地隙が2番目に小さいファイターは？',
      options: ['インクリング', 'ヒカリ', 'メタナイト', 'ピーチ/デイジー'],
      answer: 2,
      refLink: './parameter/parameter3.html#空下着地隙'
    },
    {
    ...
    {
      question: '次の4人のうち、シールドサイズが一番大きいのは？',
      options: ['射撃Mii', 'ルカリオ', '剣術Mii', 'ゼルダ'],
      answer: 3,
      refLink: './parameter/parameter1.html#シールドサイズ'
    },
    {
      question: '次の4人のうち、空前発生Fが一番小さいのは？',
      options: ['ロボット', 'クッパJr.', 'ヨッシー', 'リュカ'],
      answer: 0,
      refLink: './parameter/parameter3.html#空前発生F'
    },
    {
    ...
    },
    {
      ...
      options: ['ロックマン', 'ミュウツー', 'ゲッコウガ', 'プリン'],
      answer: 3,
      refLink: './parameter/parameter1.html#空中抵抗'
    },
    {
      question: '歩行加速量が3番目に小さいファイターは？',
      options: ['ケン', 'キングクルール', 'バンジョー＆カズーイ', 'リュウ'],
      answer: 2,
      refLink: './parameter/parameter1.html#歩行加速量'
    },
    {
      question: '次の4人のうち、上強発生Fが一番大きいのは？',
      options: ['アイク', 'キングクルール', 'ゼルダ', 'ピチュー'],
      answer: 0,
      refLink: './parameter/parameter2.html#上強発生F'
    },
    {
    ...
    },
    {
      ...
      options: ['カービィ', 'ゼロスーツサムス', 'リトルマック', 'リュカ'],
      answer: 1,
      refLink: './parameter/parameter2.html#上強発生F'
    },
    {
      question: '横強発生Fが3番目に小さいファイターは？',
      options: ['スネーク', 'ゼニガメ', 'ピチュー', 'カービィ'],
      answer: 0,
      refLink: './parameter/parameter2.html#横強発生F'
    },
    {
    ...
    {
      question: '次の4人のうち、空後全体Fが一番大きいのは？',
      options: ['ホムラ', 'パックンフラワー', 'ロックマン', 'スティーブ'],
      answer: 1,
      refLink: './parameter/parameter3.html#空後全体F'
    },
    {
      question: '急降下速度が2番目に大きいファイターは？',
      options: ['フォックス', '格闘Mii', 'リトルマック', 'ジョーカー'],
      answer: 2,
      refLink: './parameter/parameter1.html#急降下速度'
    },
    {
      question: '空上全体Fが2番目に大きいファイターは？',
      options: ['スティーブ', 'キングクルール', 'クッパJr.', 'こどもリンク'],
      answer: 3,
      refLink: './parameter/parameter3.html#空上全体F'
    },
    {
    ...
    {
      question: '次の4人のうち、回避上がり距離が一番大きいのは？',
      options: ['リザードン', 'カズヤ', 'ファルコ', 'ソラ'],
      answer: 2,
      refLink: './parameter/parameter1.html#回避上がり距離'
    },
    {
      question: '上強全体Fが3番目に大きいファイターは？',
      options: ['パルテナ', 'ソラ', 'アイスクライマー', 'ロックマン'],
      answer: 0,
      refLink: './parameter/parameter2.html#上強全体F'
    },
    {
      question: '次の4人のうち、DA 発生Fが一番小さいのは？',
      options: ['ネス', 'ピーチ/デイジー', 'ガオガエン', 'ソニック'],
      answer: 3,
      refLink: './parameter/parameter2.html#DA 発生F'
    },
    {
    ...
    },
    {
      ...
      options: ['リンク', 'ガノンドルフ', 'マルス', 'バンジョー＆カズーイ'],
      answer: 2,
      refLink: './parameter/parameter3.html#空前着地隙'
    },
    {
      question: '次の4人のうち、回避上がり距離が一番小さいのは？',
      options: ['パックマン', 'サムス/ダークサムス', 'カズヤ', 'ジョーカー'],
      answer: 3,
      refLink: './parameter/parameter1.html#回避上がり距離'
    },
    {
    ...
    {
      question: '次の4人のうち、横強発生Fが一番大きいのは？',
      options: ['ゼニガメ', 'ダックハント', 'ワリオ', 'ピーチ/デイジー'],
      answer: 2,
      refLink: './parameter/parameter2.html#横強発生F'
    },
    {
      question: '最大歩行速度が3番目に小さいファイターは？',
      options: ['パックンフラワー', 'プリン', 'カズヤ', 'リュウ'],
      answer: 1,
      refLink: './parameter/parameter1.html#最大歩行速度'
    },
    {
    ...
    {
      question: '次の4人のうち、DA 全体Fが一番大きいのは？',
      options: ['ネス', 'ガノンドルフ', 'デデデ', 'ピット/ブラックピット'],
      answer: 2,
      refLink: './parameter/parameter2.html#DA 全体F'
    },
    {
      question: '次の4人のうち、下スマ全体Fが一番大きいのは？',
      options: ['むらびと', 'パックンフラワー', 'ルカリオ', 'リザードン'],
      answer: 3,
      refLink: './parameter/parameter2.html#下スマ全体F'
    },
    {
    ...
    {
      question: '次の4人のうち、下スマ全体Fが一番大きいのは？',
      options: ['むらびと', 'ルフレ', 'こどもリンク', 'ガオガエン'],
      answer: 3,
      refLink: './parameter/parameter2.html#下スマ全体F'
    },
    {
      question: '次の4人のうち、空N発生Fが一番小さいのは？',
      options: ['ディディーコング', 'ドンキーコング', 'クラウド', 'ミュウツー'],
      answer: 2,
      refLink: './parameter/parameter3.html#空N発生F'
    },
    {
      question: '次の4人のうち、崖掴まり姿勢が一番小さいのは？',
      options: ['スネーク', '格闘Mii', '剣術Mii', 'ガオガエン'],
      answer: 0,
      refLink: './parameter/parameter1.html#崖掴まり姿勢'
    },
    {
      question: '次の4人のうち、空後発生Fが一番小さいのは？',
      options: ['ヒカリ', 'ワリオ', 'ホムラ', 'ソニック'],
      answer: 1,
      refLink: './parameter/parameter3.html#空後発生F'
    },
    {
      question: '次の4人のうち、横強全体Fが一番小さいのは？',
      options: ['シーク', 'リュウ', 'ファルコ', 'キングクルール'],
      answer: 1,
      refLink: './parameter/parameter2.html#横強全体F'
    },
    {
      question: '次の4人のうち、急降下速度が一番小さいのは？',
      options: ['カズヤ', 'ベヨネッタ', 'ディディーコング', 'アイク'],
      answer: 3,
      refLink: './parameter/parameter1.html#急降下速度'
    },
    {
    ...
    },
    {
      ...
      options: ['ガノンドルフ', 'ソラ', 'ゲッコウガ', 'ソニック'],
      answer: 0,
      refLink: './parameter/parameter1.html#崖掴まり姿勢'
    },
    {
      question: '空前発生Fが3番目に大きいファイターは？',
      options: ['シーク', 'クラウド', 'リンク', 'アイスクライマー'],
      answer: 1,
      refLink: './parameter/parameter3.html#空前発生F'
    },
    {
      question: '空後全体Fが3番目に小さいファイターは？',
      options: ['リンク', 'ジョーカー', 'ディディーコング', 'ドンキーコング'],
      answer: 0,
      refLink: './parameter/parameter3.html#空後全体F'
    },
    {
    ...
    {
      question: '次の4人のうち、空前発生Fが一番大きいのは？',
      options: ['ホムラ', 'ケン', 'マリオ', 'インクリング'],
      answer: 2,
      refLink: './parameter/parameter3.html#空前発生F'
    },
    {
      question: '次の4人のうち、DA 全体Fが一番小さいのは？',
      options: ['ホムラ', 'ピカチュウ', 'ベレトス', 'こどもリンク'],
      answer: 3,
      refLink: './parameter/parameter2.html#DA 全体F'
    },
    {
      question: '次の4人のうち、空後全体Fが一番小さいのは？',
      options: ['ホムラ', 'ゲッコウガ', 'クロム', 'ピーチ/デイジー'],
      answer: 2,
      refLink: './parameter/parameter3.html#空後全体F'
    },
    {
      question: '空下全体Fが3番目に小さいファイターは？',
      options: ['リトルマック', 'ルイージ', 'ルカリオ', 'テリー'],
      answer: 1,
      refLink: './parameter/parameter3.html#空下全体F'
    },
    {
    ...
    },
    {
      ...
      options: ['格闘Mii', 'フォックス', 'ピチュー', 'パックンフラワー'],
      answer: 3,
      refLink: './parameter/parameter1.html#最大落下速度'
    },
    {
      question: '空上着地隙が3番目に小さいファイターは？',
      options: ['ゼロスーツサムス', 'ワリオ', 'テリー', 'ルイージ'],
      answer: 2,
      refLink: './parameter/parameter3.html#空上着地隙'
    },
    {
    ...
    },
    {
      ...
      options: ['スティーブ', 'カービィ', 'ゼニガメ', 'ピチュー'],
      answer: 1,
      refLink: './parameter/parameter2.html#横強全体F'
    },
    {
      question: '次の4人のうち、空後着地隙が一番小さいのは？',
      options: ['格闘Mii', '勇者', 'ホムラ', 'ルイージ'],
      answer: 3,
      refLink: './parameter/parameter3.html#空後着地隙'
    },
    {
      question: '空下全体Fが2番目に小さいファイターは？',
      options: ['テリー', 'ルカリオ', 'ルイージ', 'リトルマック'],
      answer: 3,
      refLink: './parameter/parameter3.html#空下全体F'
    },
    {
    ...
    },
    {
      ...
      options: ['サムス/ダークサムス', 'リュカ', 'スネーク', 'ウルフ'],
      answer: 0,
      refLink: './parameter/parameter1.html#攻撃上がり距離'
    },
    {
      question: '次の4人のうち、小ジャンプ高さが一番小さいのは？',
      options: ['ヨッシー', 'ゼルダ', 'ドクターマリオ', 'カムイ'],
      answer: 0,
      refLink: './parameter/parameter1.html#小ジャンプ高さ'
    },
    {
      question: '次の4人のうち、空N発生Fが一番大きいのは？',
      options: ['ピクミン＆オリマー', 'ゲッコウガ', 'ルカリオ', '勇者'],
      answer: 1,
      refLink: './parameter/parameter3.html#空N発生F'
    },
    {
      question: '次の4人のうち、空下発生Fが一番小さいのは？',
      options: ['ルキナ', 'ピカチュウ', 'ソニック', 'ロゼッタ＆チコ'],
      answer: 0,
      refLink: './parameter/parameter3.html#空下発生F'
    },
    {
      question: '次の4人のうち、下強発生Fが一番小さいのは？',
      options: ['ロゼッタ＆チコ', 'ゼニガメ', 'サムス/ダークサムス', 'ソラ'],
      answer: 0,
      refLink: './parameter/parameter2.html#下強発生F'
    },
    {
    ...
    },
    {
      ...
      options: ['デデデ', '格闘Mii', 'ジョーカー', 'フォックス'],
      answer: 0,
      refLink: './parameter/parameter1.html#急降下速度'
    },
    {
      question: '重さが2番目に大きいファイターは？',
      options: ['クッパ', 'ドンキーコング', 'キングクルール', 'デデデ'],
      answer: 2,
      refLink: './parameter/parameter1.html#重さ'
    },
    {
    ...
    },
    {
      ...
      options: ['ゼロスーツサムス', 'マリオ', 'ヨッシー', 'ルイージ'],
      answer: 0,
      refLink: './parameter/parameter1.html#その場掴み発生'
    },
    {
      question: '横スマ全体Fが2番目に大きいファイターは？',
      options: ['ルイージ', '射撃Mii', 'アイク', 'スネーク'],
      answer: 1,
      refLink: './parameter/parameter2.html#横スマ全体F'
    },
    {
      question: 'その場掴み長さが3番目に大きいファイターは？',
      options: ['スティーブ', 'ミェンミェン', 'ゼロスーツサムス', 'ルイージ'],
      answer: 2,
      refLink: './parameter/parameter1.html#その場掴み長さ'
    },
    {
      question: '次の4人のうち、小ジャンプ高さが一番小さいのは？',
      options: ['Mr.ゲーム&ウォッチ', 'シーク', 'ゲッコウガ', 'セフィロス'],
      answer: 3,
      refLink: './parameter/parameter1.html#小ジャンプ高さ'
    },
    {
      question: '次の4人のうち、その場掴み長さが一番小さいのは？',
      options: ['ドクターマリオ', 'ソニック', 'ベヨネッタ', 'インクリング'],
      answer: 3,
      refLink: './parameter/parameter1.html#その場掴み長さ'
    },
    {
    ...
    },
    {
      ...
      options: ['ケン', 'カズヤ', 'スティーブ', 'リトルマック'],
      answer: 2,
      refLink: './parameter/parameter3.html#空N全体F'
    },
    {
      question: '次の4人のうち、横強全体Fが一番大きいのは？',
      options: ['メタナイト', 'ベレトス', 'ゼロスーツサムス', 'ケン'],
      answer: 1,
      refLink: './parameter/parameter2.html#横強全体F'
    },
    {
      question: '上スマ全体Fが2番目に小さいファイターは？',
      options: ['ドクターマリオ', 'Mr.ゲーム&ウォッチ', 'ピチュー', 'テリー'],
      answer: 0,
      refLink: './parameter/parameter2.html#上スマ全体F'
    },
    {
    ...
    {
      question: '次の4人のうち、空前発生Fが一番小さいのは？',
      options: ['ロゼッタ＆チコ', 'フシギソウ', 'スティーブ', 'ルイージ'],
      answer: 3,
      refLink: './parameter/parameter3.html#空前発生F'
    },
    {
      question: '次の4人のうち、空上着地隙が一番大きいのは？',
      options: ['トゥーンリンク', 'ファルコ', 'フォックス', 'ピーチ/デイジー'],
      answer: 0,
      refLink: './parameter/parameter3.html#空上着地隙'
    },
    {
      question: '次の4人のうち、空後発生Fが一番大きいのは？',
      options: ['ロボット', 'アイスクライマー', 'ピーチ/デイジー', 'ルキナ'],
      answer: 0,
      refLink: './parameter/parameter3.html#空後発生F'
    },
    {
      question: '次の4人のうち、横スマ全体Fが一番大きいのは？',
      options: ['ワリオ', 'ピチュー', 'アイク', 'ミュウツー'],
      answer: 2,
      refLink: './parameter/parameter2.html#横スマ全体F'
    },
    {
      question: '空下全体Fが2番目に大きいファイターは？',
      options: ['リンク', 'メタナイト', 'クッパ', 'リトルマック'],
      answer: 0,
      refLink: './parameter/parameter3.html#空下全体F'
    },
    {
      question: '次の4人のうち、下スマ発生Fが一番大きいのは？',
      options: ['デデデ', '射撃Mii', 'スティーブ', '剣術Mii'],
      answer: 0,
      refLink: './parameter/parameter2.html#下スマ発生F'
    },
    {
    ...
    {
      question: '次の4人のうち、横スマ全体Fが一番小さいのは？',
      options: ['Mr.ゲーム&ウォッチ', 'プリン', 'ウルフ', 'カズヤ'],
      answer: 2,
      refLink: './parameter/parameter2.html#横スマ全体F'
    },
    {
    ...
    {
      question: '次の4人のうち、最大空中速度が一番大きいのは？',
      options: ['プリン', 'リュウ', 'テリー', 'ベレトス'],
      answer: 0,
      refLink: './parameter/parameter1.html#最大空中速度'
    },
    {
      question: 'DA 全体Fが3番目に小さいファイターは？',
      options: ['ゲッコウガ', 'トゥーンリンク', 'メタナイト', 'フォックス'],
      answer: 3,
      refLink: './parameter/parameter2.html#DA 全体F'
    },
    {
      question: '次の4人のうち、上スマ発生Fが一番大きいのは？',
      options: ['パルテナ', 'ベヨネッタ', 'リュカ', 'ピット/ブラックピット'],
      answer: 2,
      refLink: './parameter/parameter2.html#上スマ発生F'
    },
    {
      question: '空前全体Fが3番目に小さいファイターは？',
      options: ['ロイ', 'パックマン', 'クロム', 'ルカリオ'],
      answer: 3,
      refLink: './parameter/parameter3.html#空前全体F'
    },
    {
    ...
    },
    {
      ...
      options: ['ゼニガメ', 'むらびと', 'アイスクライマー', 'こどもリンク'],
      answer: 3,
      refLink: './parameter/parameter1.html#回避上がり距離'
    },
    {
      question: '次の4人のうち、空前全体Fが一番小さいのは？',
      options: ['ピット/ブラックピット', 'テリー', 'リンク', 'ケン'],
      answer: 3,
      refLink: './parameter/parameter3.html#空前全体F'
    },
    {
      question: '次の4人のうち、DA 全体Fが一番小さいのは？',
      options: ['プリン', 'ヒカリ', 'テリー', 'パルテナ'],
      answer: 1,
      refLink: './parameter/parameter2.html#DA 全体F'
    },
    {
      question: '空上発生Fが2番目に小さいファイターは？',
      options: ['こどもリンク', 'ジョーカー', 'ケン', 'シーク'],
      answer: 3,
      refLink: './parameter/parameter3.html#空上発生F'
    },
    {
    ...
    },
    {
      ...
      options: ['ルイージ', 'ゼロスーツサムス', 'ファルコ', 'ゲッコウガ'],
      answer: 3,
      refLink: './parameter/parameter1.html#大ジャンプ高さ'
    },
    {
      question: '次の4人のうち、急降下速度が一番小さいのは？',
      options: ['フシギソウ', 'ピーチ/デイジー', 'ケン', 'トゥーンリンク'],
      answer: 1,
      refLink: './parameter/parameter1.html#急降下速度'
    },
    {
      question: '次の4人のうち、空前全体Fが一番大きいのは？',
      options: ['ガオガエン', 'ヨッシー', 'ウルフ', 'セフィロス'],
      answer: 0,
      refLink: './parameter/parameter3.html#空前全体F'
    },
    {
    ...
    {
      question: '次の4人のうち、空上全体Fが一番大きいのは？',
      options: ['ベヨネッタ', 'テリー', 'クロム', 'ミュウツー'],
      answer: 2,
      refLink: './parameter/parameter3.html#空上全体F'
    },
    {
      question: '次の4人のうち、その場掴み長さが一番大きいのは？',
      options: ['ゼニガメ', 'マリオ', 'マルス', 'ロゼッタ＆チコ'],
      answer: 2,
      refLink: './parameter/parameter1.html#その場掴み長さ'
    },
    {
      question: '次の4人のうち、大ジャンプ高さが一番大きいのは？',
      options: ['ルフレ', 'ルイージ', 'スネーク', 'ヨッシー'],
      answer: 1,
      refLink: './parameter/parameter1.html#大ジャンプ高さ'
    },
    {
    ...
    },
    {
      ...
      options: ['プリン', 'ソラ', 'フォックス', 'ゲッコウガ'],
      answer: 1,
      refLink: './parameter/parameter1.html#重力'
    },
    {
      question: '次の4人のうち、地上抵抗が一番小さいのは？',
      options: ['ガオガエン', 'サムス/ダークサムス', 'ルイージ', 'むらびと'],
      answer: 1,
      refLink: './parameter/parameter1.html#地上抵抗'
    },
    {
    ...
    {
      question: '次の4人のうち、最大落下速度が一番小さいのは？',
      options: ['ウルフ', 'ゼニガメ', 'マリオ', 'ロイ'],
      answer: 1,
      refLink: './parameter/parameter1.html#最大落下速度'
    },
    {
      question: '上スマ発生Fが3番目に大きいファイターは？',
      options: ['キャプテン・ファルコン', 'アイク', 'セフィロス', 'フシギソウ'],
      answer: 1,
      refLink: './parameter/parameter2.html#上スマ発生F'
    },
    {
      question: '次の4人のうち、最大空中速度が一番小さいのは？',
      options: ['勇者', 'リンク', 'しずえ', 'ソニック'],
      answer: 1,
      refLink: './parameter/parameter1.html#最大空中速度'
    },
    {
      question: '横スマ全体Fが3番目に大きいファイターは？',
      options: ['ルイージ', 'クッパ', 'デデデ', 'スネーク'],
      answer: 2,
      refLink: './parameter/parameter2.html#横スマ全体F'
    },
    {
      question: 'DA 発生Fが2番目に大きいファイターは？',
      options: ['デデデ', '勇者', 'ホムラ', 'リンク'],
      answer: 1,
      refLink: './parameter/parameter2.html#DA 発生F'
    },
    {
      question: '空上全体Fが2番目に小さいファイターは？',
      options: ['ピカチュウ', 'クッパJr.', 'スティーブ', 'ピチュー'],
      answer: 1,
      refLink: './parameter/parameter3.html#空上全体F'
    },
    {
    ...
    },
    {
      ...
      options: ['ゼニガメ', 'ルイージ', 'スネーク', 'Mr.ゲーム&ウォッチ'],
      answer: 2,
      refLink: './parameter/parameter1.html#攻撃上がり距離'
    },
    {
    ...
    {
      question: '次の4人のうち、空中抵抗が一番大きいのは？',
      options: ['ソニック', 'ミェンミェン', 'ロボット', 'マルス'],
      answer: 2,
      refLink: './parameter/parameter1.html#空中抵抗'
    },
    {
      question: '上スマ全体Fが3番目に小さいファイターは？',
      options: ['Mr.ゲーム&ウォッチ', 'マリオ', 'ピチュー', 'テリー'],
      answer: 1,
      refLink: './parameter/parameter2.html#上スマ全体F'
    },
    {
      question: '次の4人のうち、上スマ発生Fが一番大きいのは？',
      options: ['むらびと', 'ジョーカー', 'クッパ', 'カービィ'],
      answer: 2,
      refLink: './parameter/parameter2.html#上スマ発生F'
    },
    {
    ...
    {
      question: '次の4人のうち、その場掴み発生が一番小さいのは？',
      options: ['ロゼッタ＆チコ', 'ロックマン', 'ソニック', 'カービィ'],
      answer: 0,
      refLink: './parameter/parameter1.html#その場掴み発生'
    },
    {
    ...
    {
      question: '次の4人のうち、ダッシュ加速量が一番小さいのは？',
      options: ['シーク', 'ルカリオ', 'ヨッシー', 'ガオガエン'],
      answer: 3,
      refLink: './parameter/parameter1.html#ダッシュ加速量'
    },
    {
      question: '上スマ全体Fが3番目に大きいファイターは？',
      options: ['キングクルール', 'アイク', 'スティーブ', 'リンク'],
      answer: 2,
      refLink: './parameter/parameter2.html#上スマ全体F'
    },
    {
      question: '次の4人のうち、下強全体Fが一番小さいのは？',
      options: ['ゼニガメ', 'キャプテン・ファルコン', 'ジョーカー', 'ベレトス'],
      answer: 0,
      refLink: './parameter/parameter2.html#下強全体F'
    },
    {
    ...
    {
      question: '次の4人のうち、歩行加速量が一番大きいのは？',
      options: ['ソニック', 'ヨッシー', 'ルキナ', 'ケン'],
      answer: 3,
      refLink: './parameter/parameter1.html#歩行加速量'
    },
    {
      question: '次の4人のうち、最大ダッシュ速度が一番大きいのは？',
      options: ['クラウド', 'ケン', 'ルフレ', 'ワリオ'],
      answer: 0,
      refLink: './parameter/parameter1.html#最大ダッシュ速度'
    },
    {
      question: '次の4人のうち、横強発生Fが一番小さいのは？',
      options: ['ルフレ', 'クッパ', 'ホムラ', 'ヨッシー'],
      answer: 3,
      refLink: './parameter/parameter2.html#横強発生F'
    },
    {
    ...
    {
      question: '次の4人のうち、大ジャンプ高さが一番小さいのは？',
      options: ['クロム', 'ゼルダ', 'ゼロスーツサムス', 'クッパJr.'],
      answer: 0,
      refLink: './parameter/parameter1.html#大ジャンプ高さ'
    },
    {
    ...
    {
      question: '次の4人のうち、地上抵抗が一番大きいのは？',
      options: ['Mr.ゲーム&ウォッチ', 'キングクルール', 'ミュウツー', 'ルキナ'],
      answer: 0,
      refLink: './parameter/parameter1.html#地上抵抗'
    },
    {
    ...
    },
    {
      ...
      options: ['リンク', 'ディディーコング', 'サムス/ダークサムス', '勇者'],
      answer: 0,
      refLink: './parameter/parameter1.html#その場掴み長さ'
    },
    {
    ...
    {
      question: '次の4人のうち、ダッシュ初速度が一番小さいのは？',
      options: ['シーク', 'リドリー', 'リュカ', 'シモン/リヒター'],
      answer: 3,
      refLink: './parameter/parameter1.html#ダッシュ初速度'
    },
    {
      question: '空N全体Fが3番目に大きいファイターは？',
      options: ['アイク', 'リトルマック', 'スティーブ', 'ソラ'],
      answer: 0,
      refLink: './parameter/parameter3.html#空N全体F'
    },
    {
      question: '次の4人のうち、下スマ発生Fが一番小さいのは？',
      options: ['マリオ', 'シモン/リヒター', 'ヨッシー', '射撃Mii'],
      answer: 0,
      refLink: './parameter/parameter2.html#下スマ発生F'
    },
    {
      question: '次の4人のうち、上強全体Fが一番大きいのは？',
      options: ['ソラ', 'ドクターマリオ', 'マルス', 'リザードン'],
      answer: 0,
      refLink: './parameter/parameter2.html#上強全体F'
    },
    {
      question: 'ダッシュ初速度が3番目に小さいファイターは？',
      options: ['射撃Mii', 'カズヤ', 'ピクミン＆オリマー', 'ドクターマリオ'],
      answer: 1,
      refLink: './parameter/parameter1.html#ダッシュ初速度'
    },
    {
      question: '急降下速度が2番目に小さいファイターは？',
      options: ['ロゼッタ＆チコ', 'プリン', 'カービィ', 'ピーチ/デイジー'],
      answer: 3,
      refLink: './parameter/parameter1.html#急降下速度'
    },
    {
    ...
    {
      question: '次の4人のうち、空前着地隙が一番大きいのは？',
      options: ['クッパJr.', 'ソニック', 'ゼルダ', 'ディディーコング'],
      answer: 1,
      refLink: './parameter/parameter3.html#空前着地隙'
    },
    {
      question: '攻撃上がり距離が2番目に大きいファイターは？',
      options: ['ガノンドルフ', 'リンク', 'クッパ', 'ドンキーコング'],
      answer: 1,
      refLink: './parameter/parameter1.html#攻撃上がり距離'
    },
    {
    ...
    {
      question: '次の4人のうち、小ジャンプ高さが一番小さいのは？',
      options: ['ガオガエン', 'ロイ', 'ネス', 'メタナイト'],
      answer: 1,
      refLink: './parameter/parameter1.html#小ジャンプ高さ'
    },
    {
      question: '次の4人のうち、空下発生Fが一番小さいのは？',
      options: ['キングクルール', '勇者', 'フォックス', 'リュカ'],
      answer: 2,
      refLink: './parameter/parameter3.html#空下発生F'
    },
    {
      question: '攻撃上がり距離が3番目に大きいファイターは？',
      options: ['ドンキーコング', 'ガノンドルフ', 'ミュウツー', 'クッパ'],
      answer: 2,
      refLink: './parameter/parameter1.html#攻撃上がり距離'
    },
    {
      question: '次の4人のうち、崖掴まり姿勢が一番大きいのは？',
      options: ['ゼロスーツサムス', 'むらびと', 'クラウド', 'デデデ'],
      answer: 1,
      refLink: './parameter/parameter1.html#崖掴まり姿勢'
    },
    {
    ...
    },
    {
      ...
      options: ['ピット/ブラックピット', 'テリー', 'リトルマック', 'ファルコ'],
      answer: 3,
      refLink: './parameter/parameter3.html#空N発生F'
    },
    {
    ...
    {
      question: '次の4人のうち、空中抵抗が一番大きいのは？',
      options: ['パックマン', 'Wii Fit トレーナー', 'ピチュー', 'クッパ'],
      answer: 0,
      refLink: './parameter/parameter1.html#空中抵抗'
    },
    {
    ...
    {
      question: '次の4人のうち、崖掴まり姿勢が一番小さいのは？',
      options: ['ピクミン＆オリマー', 'ルイージ', 'テリー', 'アイスクライマー'],
      answer: 2,
      refLink: './parameter/parameter1.html#崖掴まり姿勢'
    },
    {
    ...
    {
      question: '次の4人のうち、その場掴み発生が一番大きいのは？',
      options: ['デデデ', 'ゼルダ', 'ウルフ', 'クラウド'],
      answer: 1,
      refLink: './parameter/parameter1.html#その場掴み発生'
    },
    {
      question: '空後発生Fが3番目に小さいファイターは？',
      options: ['ピカチュウ', 'ゲッコウガ', 'ゼニガメ', 'Wii Fit トレーナー'],
      answer: 0,
      refLink: './parameter/parameter3.html#空後発生F'
    },
    {
    ...
    {
      question: '次の4人のうち、空上全体Fが一番小さいのは？',
      options: ['ミェンミェン', 'デデデ', 'ピクミン＆オリマー', 'クッパJr.'],
      answer: 3,
      refLink: './parameter/parameter3.html#空上全体F'
    },
    {
    ...
    {
      question: '次の4人のうち、重さが一番大きいのは？',
      options: ['射撃Mii', 'シュルク', 'ディディーコング', 'リュカ'],
      answer: 0,
      refLink: './parameter/parameter1.html#重さ'
    },
    {
      question: '次の4人のうち、地上抵抗が一番大きいのは？',
      options: ['バンジョー＆カズーイ', 'ゲッコウガ', 'マリオ', 'ヨッシー'],
      answer: 2,
      refLink: './parameter/parameter1.html#地上抵抗'
    },
    {
      question: '最大歩行速度が3番目に大きいファイターは？',
      options: ['ルキナ', 'ゲッコウガ', 'ゼロスーツサムス', 'フォックス'],
      answer: 3,
      refLink: './parameter/parameter1.html#最大歩行速度'
    },
    {
    ...
    {
      question: '次の4人のうち、空N着地隙が一番大きいのは？',
      options: ['アイク', 'ロゼッタ＆チコ', 'プリン', 'テリー'],
      answer: 2,
      refLink: './parameter/parameter3.html#空N着地隙'
    },
    {
      question: '次の4人のうち、空中ジャンプ高さが一番小さいのは？',
      options: ['しずえ', 'ピチュー', 'Mr.ゲーム&ウォッチ', 'ケン'],
      answer: 2,
      refLink: './parameter/parameter1.html#空中ジャンプ高さ'
    },
    {
    ...
    },
    {
      ...
      options: ['ディディーコング', 'こどもリンク', 'ジョーカー', 'ケン'],
      answer: 0,
      refLink: './parameter/parameter3.html#空上発生F'
    },
    {
      question: '空後着地隙が3番目に小さいファイターは？',
      options: ['リンク', 'ミェンミェン', 'アイスクライマー', 'シーク'],
      answer: 0,
      refLink: './parameter/parameter3.html#空後着地隙'
    },
    {
      question: '最大ダッシュ速度が2番目に大きいファイターは？',
      options: ['ソニック', 'シーク', 'キャプテン・ファルコン', 'リトルマック'],
      answer: 2,
      refLink: './parameter/parameter1.html#最大ダッシュ速度'
    },
    {
    ...
    },
    {
      ...
      options: ['ドンキーコング', 'アイスクライマー', 'スネーク', 'クラウド'],
      answer: 1,
      refLink: './parameter/parameter3.html#空前発生F'
    },
    {
    ...
    {
      question: '次の4人のうち、崖掴まり姿勢が一番大きいのは？',
      options: ['ゼルダ', '勇者', 'ピチュー', '格闘Mii'],
      answer: 2,
      refLink: './parameter/parameter1.html#崖掴まり姿勢'
    },
    {
      question: '次の4人のうち、空中ジャンプ高さが一番大きいのは？',
      options: ['インクリング', 'シュルク', 'リザードン', 'プリン'],
      answer: 0,
      refLink: './parameter/parameter1.html#空中ジャンプ高さ'
    },
    {
    ...
    },
    {
      ...
      options: ['ゼロスーツサムス', 'リトルマック', 'リザードン', 'ソニック'],
      answer: 1,
      refLink: './parameter/parameter1.html#ダッシュ初速度'
    },
    {
      question: '空上全体Fが3番目に大きいファイターは？',
      options: ['リンク', 'スティーブ', 'クッパJr.', 'ピチュー'],
      answer: 0,
      refLink: './parameter/parameter3.html#空上全体F'
    },
    {
    ...
    {
      question: '次の4人のうち、空N発生Fが一番大きいのは？',
      options: ['ダックハント', 'ドクターマリオ', '剣術Mii', 'クラウド'],
      answer: 2,
      refLink: './parameter/parameter3.html#空N発生F'
    },
    {
    ...
    },
    {
      ...
      options: ['セフィロス', 'ケン', 'キングクルール', 'バンジョー＆カズーイ'],
      answer: 2,
      refLink: './parameter/parameter1.html#歩行加速量'
    },
    {
      question: '大ジャンプ高さが3番目に小さいファイターは？',
      options: ['プリン', 'カズヤ', 'スネーク', 'カービィ'],
      answer: 0,
      refLink: './parameter/parameter1.html#大ジャンプ高さ'
    },
    {
    ...
    },
    {
      ...
      options: ['むらびと', 'リトルマック', 'ピット/ブラックピット', 'テリー'],
      answer: 0,
      refLink: './parameter/parameter3.html#空N発生F'
    },
    {
    ...
    },
    {
      ...
      options: ['スティーブ', 'ケン', 'インクリング', 'リュウ'],
      answer: 0,
      refLink: './parameter/parameter3.html#空N着地隙'
    },
    {
      question: 'DA 発生Fが3番目に小さいファイターは？',
      options: ['ワリオ', 'フシギソウ', 'プリン', 'シーク'],
      answer: 1,
      refLink: './parameter/parameter2.html#DA 発生F'
    },
    {
      question: '次の4人のうち、最大空中速度が一番小さいのは？',
      options: ['Wii Fit トレーナー', 'ドンキーコング', 'ファルコ', 'スネーク'],
      answer: 2,
      refLink: './parameter/parameter1.html#最大空中速度'
    },
    {
    ...
    {
      question: '次の4人のうち、空下着地隙が一番大きいのは？',
      options: ['スネーク', 'むらびと', '勇者', 'カズヤ'],
      answer: 3,
      refLink: './parameter/parameter3.html#空下着地隙'
    },
    {
      question: '横強全体Fが3番目に大きいファイターは？',
      options: ['デデデ', 'ミェンミェン', 'パルテナ', 'ロックマン'],
      answer: 2,
      refLink: './parameter/parameter2.html#横強全体F'
    },
    {
    ...
    {
      question: '次の4人のうち、攻撃上がり距離が一番小さいのは？',
      options: ['勇者', 'ガノンドルフ', 'パックマン', 'ルイージ'],
      answer: 3,
      refLink: './parameter/parameter1.html#攻撃上がり距離'
    },
    {
      question: '下スマ発生Fが2番目に大きいファイターは？',
      options: ['リドリー', 'キングクルール', 'ミュウツー', 'セフィロス'],
      answer: 1,
      refLink: './parameter/parameter2.html#下スマ発生F'
    },
    {
      question: '空中抵抗が3番目に小さいファイターは？',
      options: ['ロックマン', 'プリン', 'ワリオ', '剣術Mii'],
      answer: 3,
      refLink: './parameter/parameter1.html#空中抵抗'
    },
    {
    ...
    {
      question: '次の4人のうち、ダッシュ加速量が一番小さいのは？',
      options: ['ファルコ', 'ベレトス', 'リドリー', 'キングクルール'],
      answer: 3,
      refLink: './parameter/parameter1.html#ダッシュ加速量'
    },
    {
    ...
    {
      question: '次の4人のうち、ダッシュ加速量が一番大きいのは？',
      options: ['ソニック', 'トゥーンリンク', 'ファルコ', 'リンク'],
      answer: 0,
      refLink: './parameter/parameter1.html#ダッシュ加速量'
    },
    {
      question: '重さが2番目に小さいファイターは？',
      options: ['Mr.ゲーム&ウォッチ', 'プリン', 'ゼニガメ', 'ピチュー'],
      answer: 1,
      refLink: './parameter/parameter1.html#重さ'
    },
    {
      question: '空後発生Fが3番目に大きいファイターは？',
      options: ['キングクルール', 'シーク', 'デデデ', 'シュルク'],
      answer: 0,
      refLink: './parameter/parameter3.html#空後発生F'
    },
    {
    ...
    {
      question: '次の4人のうち、横スマ発生Fが一番大きいのは？',
      options: ['シモン/リヒター', 'トゥーンリンク', 'クッパJr.', 'ガオガエン'],
      answer: 0,
      refLink: './parameter/parameter2.html#横スマ発生F'
    },
    {
    ...
    },
    {
      ...
      options: ['スティーブ', 'ロボット', 'フォックス', 'ゲッコウガ'],
      answer: 3,
      refLink: './parameter/parameter2.html#DA 全体F'
    },
    {
    ...
    {
      question: '次の4人のうち、空後着地隙が一番大きいのは？',
      options: ['リトルマック', 'メタナイト', 'ゲッコウガ', 'ドクターマリオ'],
      answer: 0,
      refLink: './parameter/parameter3.html#空後着地隙'
    },
    {
      question: 'その場掴み発生が2番目に小さいファイターは？',
      options: ['ピカチュウ', 'ミュウツー', 'リンク', 'ロイ'],
      answer: 2,
      refLink: './parameter/parameter1.html#その場掴み発生'
    },
    {
    ...
    {
      question: '次の4人のうち、DA 発生Fが一番小さいのは？',
      options: ['ソラ', 'リュウ', 'ワリオ', 'ソニック'],
      answer: 3,
      refLink: './parameter/parameter2.html#DA 発生F'
    },
    {
      question: '空上発生Fが2番目に大きいファイターは？',
      options: ['射撃Mii', 'セフィロス', 'シモン/リヒター', 'シュルク'],
      answer: 1,
      refLink: './parameter/parameter3.html#空上発生F'
    },
    {
      question: '次の4人のうち、下スマ全体Fが一番大きいのは？',
      options: ['ケン', 'ルキナ', 'ディディーコング', 'キングクルール'],
      answer: 3,
      refLink: './parameter/parameter2.html#下スマ全体F'
    },
    {
      question: '空後発生Fが2番目に小さいファイターは？',
      options: ['Wii Fit トレーナー', 'ゼニガメ', 'ロックマン', 'ゲッコウガ'],
      answer: 2,
      refLink: './parameter/parameter3.html#空後発生F'
    },
    {
      question: '攻撃上がり距離が3番目に小さいファイターは？',
      options: ['ルイージ', 'スネーク', 'クッパ', 'リンク'],
      answer: 0,
      refLink: './parameter/parameter1.html#攻撃上がり距離'
    },
    {
    ...
    {
      question: '次の4人のうち、最大ダッシュ速度が一番小さいのは？',
      options: ['ベレトス', 'ミェンミェン', '格闘Mii', 'ミュウツー'],
      answer: 0,
      refLink: './parameter/parameter1.html#最大ダッシュ速度'
    },
    {
    ...
    },
    {
      ...
      options: ['ピチュー', 'キングクルール', 'パックンフラワー', 'ヨッシー'],
      answer: 1,
      refLink: './parameter/parameter3.html#空後全体F'
    },
    {
      question: '最大落下速度が2番目に小さいファイターは？',
      options: ['カービィ', 'ロゼッタ＆チコ', 'プリン', 'ピーチ/デイジー'],
      answer: 3,
      refLink: './parameter/parameter1.html#最大落下速度'
    },
    {
    ...
    {
      question: '次の4人のうち、最大空中速度が一番小さいのは？',
      options: ['ミェンミェン', 'デデデ', 'ルイージ', 'トゥーンリンク'],
      answer: 1,
      refLink: './parameter/parameter1.html#最大空中速度'
    },
    {
    ...
    },
    {
      ...
      options: ['ピカチュウ', 'ミュウツー', 'カービィ', 'ロイ'],
      answer: 2,
      refLink: './parameter/parameter1.html#その場掴み発生'
    },
    {
      question: '横スマ発生Fが3番目に大きいファイターは？',
      options: ['カズヤ', 'デデデ', 'アイク', 'ガノンドルフ'],
      answer: 2,
      refLink: './parameter/parameter2.html#横スマ発生F'
    },
    {
      question: 'ダッシュ加速量が3番目に小さいファイターは？',
      options: ['ルフレ', 'ルカリオ', 'シュルク', 'ソラ'],
      answer: 2,
      refLink: './parameter/parameter1.html#ダッシュ加速量'
    },
    {
    ...
    },
    {
      ...
      options: ['ルイージ', 'ガノンドルフ', 'デデデ', 'アイスクライマー'],
      answer: 0,
      refLink: './parameter/parameter1.html#最大空中速度'
    },
    {
    ...
    },
    {
      ...
      options: ['メタナイト', 'ロボット', 'トゥーンリンク', 'クッパ'],
      answer: 2,
      refLink: './parameter/parameter3.html#空下全体F'
    },
    {
      question: '空中加速が3番目に小さいファイターは？',
      options: ['プリン', 'シモン/リヒター', 'パルテナ', 'ガノンドルフ'],
      answer: 3,
      refLink: './parameter/parameter1.html#空中加速'
    },
    {
    ...
    {
      question: '次の4人のうち、空下着地隙が一番小さいのは？',
      options: ['アイスクライマー', 'ベヨネッタ', 'アイク', 'ミェンミェン'],
      answer: 2,
      refLink: './parameter/parameter3.html#空下着地隙'
    },
    {
    ...
    },
    {
      ...
      options: ['ミュウツー', 'プリン', 'ロイ', 'クロム'],
      answer: 0,
      refLink: './parameter/parameter1.html#最大空中速度'
    },
    {
      question: 'DA 発生Fが3番目に大きいファイターは？',
      options: ['勇者', 'ホムラ', 'リンク', 'アイク'],
      answer: 2,
      refLink: './parameter/parameter2.html#DA 発生F'
    },
    {
    ...
    },
    {
      ...
      options: ['パルテナ', 'バンジョー＆カズーイ', 'キングクルール', 'リュウ'],
      answer: 2,
      refLink: './parameter/parameter2.html#下強発生F'
    },
    {
    ...
    {
      question: '次の4人のうち、空上発生Fが一番小さいのは？',
      options: ['キャプテン・ファルコン', 'ゼニガメ', 'アイク', 'マルス'],
      answer: 3,
      refLink: './parameter/parameter3.html#空上発生F'
    },
    {
    ...
    },
    {
      ...
      options: ['ガオガエン', 'リュウ', 'プリン', 'カズヤ'],
      answer: 3,
      refLink: './parameter/parameter1.html#最大歩行速度'
    },
    {
      question: '歩行加速量が2番目に大きいファイターは？',
      options: ['リュウ', 'ミュウツー', 'ケン', 'スティーブ'],
      answer: 0,
      refLink: './parameter/parameter1.html#歩行加速量'
    },
    {
    ...
    {
      question: '次の4人のうち、攻撃上がり距離が一番小さいのは？',
      options: ['ルイージ', 'クッパJr.', 'ドクターマリオ', 'パルテナ'],
      answer: 0,
      refLink: './parameter/parameter1.html#攻撃上がり距離'
    },
    {
    ...
    },
    {
      ...
      options: ['アイク', 'スネーク', 'ガノンドルフ', 'デデデ'],
      answer: 3,
      refLink: './parameter/parameter2.html#横スマ発生F'
    },
    {
      question: '重さが3番目に小さいファイターは？',
      options: ['クッパ', 'プリン', 'フォックス', 'Mr.ゲーム&ウォッチ'],
      answer: 3,
      refLink: './parameter/parameter1.html#重さ'
    },
    {
    ...
    },
    {
      ...
      options: ['ロックマン', 'プリン', 'ワリオ', 'ウルフ'],
      answer: 3,
      refLink: './parameter/parameter1.html#空中抵抗'
    },
    {
      question: '次の4人のうち、上スマ全体Fが一番小さいのは？',
      options: ['アイク', 'ルキナ', '射撃Mii', 'ヨッシー'],
      answer: 3,
      refLink: './parameter/parameter2.html#上スマ全体F'
    },
    {
    ...
    },
    {
      ...
      options: ['デデデ', 'キングクルール', 'トゥーンリンク', 'リンク'],
      answer: 1,
      refLink: './parameter/parameter2.html#DA 全体F'
    },
    {
      question: '空後着地隙が2番目に大きいファイターは？',
      options: ['リザードン', 'スネーク', 'ミェンミェン', 'クッパ'],
      answer: 0,
      refLink: './parameter/parameter3.html#空後着地隙'
    },
    {
    ...
    {
      question: '次の4人のうち、シールドサイズが一番大きいのは？',
      options: ['ベレトス', 'ダックハント', 'ゼニガメ', 'シュルク'],
      answer: 0,
      refLink: './parameter/parameter1.html#シールドサイズ'
    },
    {
      question: '空下発生Fが2番目に小さいファイターは？',
      options: ['メタナイト', 'フォックス', 'スネーク', 'マリオ'],
      answer: 0,
      refLink: './parameter/parameter3.html#空下発生F'
    },
    {
    ...
    },
    {
      ...
      options: ['ソラ', 'ベヨネッタ', 'スネーク', 'サムス/ダークサムス'],
      answer: 1,
      refLink: './parameter/parameter3.html#空前全体F'
    },
    {
    ...
    },
    {
      ...
      options: ['スティーブ', 'カズヤ', 'ピクミン＆オリマー', 'ドクターマリオ'],
      answer: 3,
      refLink: './parameter/parameter1.html#ダッシュ初速度'
    },
    {
      question: '重力が2番目に大きいファイターは？',
      options: ['シーク', 'フォックス', '格闘Mii', 'ゲッコウガ'],
      answer: 3,
      refLink: './parameter/parameter1.html#重力'
    },
    {
    ...
    },
    {
      ...
      options: ['ルイージ', 'カービィ', 'ヨッシー', 'アイスクライマー'],
      answer: 3,
      refLink: './parameter/parameter1.html#最大空中速度'
    },
    {
    ...
    },
    {
      ...
      options: ['ルイージ', 'ディディーコング', 'ベヨネッタ', 'ゲッコウガ'],
      answer: 2,
      refLink: './parameter/parameter1.html#小ジャンプ高さ'
    },
    {
    ...
    {
      question: '次の4人のうち、空上発生Fが一番大きいのは？',
      options: ['格闘Mii', 'ルカリオ', 'アイク', 'むらびと'],
      answer: 2,
      refLink: './parameter/parameter3.html#空上発生F'
    },
    {
      question: '上スマ発生Fが3番目に小さいファイターは？',
      options: ['ファルコ', 'ディディーコング', 'クッパJr.', 'リザードン'],
      answer: 3,
      refLink: './parameter/parameter2.html#上スマ発生F'
    },
    {
    ...
    },
    {
      ...
      options: ['リトルマック', 'ヒカリ', 'シーク', 'キャプテン・ファルコン'],
      answer: 0,
      refLink: './parameter/parameter1.html#最大ダッシュ速度'
    },
    {
  ...
  let totalCorrect = parseInt(
    localStorage.getItem('smashAna_totalCorrect') || '0'
  );
